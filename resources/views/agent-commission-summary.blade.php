<?php $page="agent-commission-summary";?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Commission Summary</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="isax isax-grid-55"></i></a></li>
                            <li class="breadcrumb-item active" aria-current="page">Commission Summary</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('agent-commission-summary')}}"
                                                class="fs-14 d-inline-flex align-items-center active">Commission
                                                Summary</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="col-xl-9 col-lg-8 theiaStickySidebar">
                    ...
                    <div class="card booking-header border-0">
                        <div
                            ...
                            <div>
                                <h6 class="mb-1">Commission Summary</h6>
                                <p class="fs-14 text-gray-6 fw-normal ">No of Payouts : 150</p>
                            </div>
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/hotels/hotel-01.jpg')}}" alt="img"
                                            ...
                                            <td>$50</td>
                                            <td>$450</td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#upcoming"><i
                                                        class="isax isax-eye"></i></a></td>
                                        </tr>

                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CB-4581</a></td>
                                            <td>Car</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/cars/car-01.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Volkswagen Amarok</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#TR-1458</a></td>
                                            <td>Tour</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/hotels/hotel-02.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('tour-details')}}">Snorkeling Tour</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#FL-2315</a></td>
                                            <td>Flight</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/flight/flight-01.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('flight-details')}}">Antonov An-32</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CB-6545</a></td>
                                            <td>Car</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/cars/car-02.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Ford Mustang 4.0 AT</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CR-3654</a></td>
                                            <td>Cruise</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/cruise/cruise-01.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#GB-6589</a></td>
                                            <td>Guide</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/guide/guide-01.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#FL-5414</a></td>
                                            <td>Flight</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-lg rounded-circle me-2">
                                                        <img src="{{URL::asset('build/img/flight/flight-02.jpg')}}" alt="img"
                                                            class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('flight-details')}}">Nimbus 345</a></p>
