        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Cruise Details</h2>
                    ...
                    <div>
                        <div class="service-wrap slider-wrap-four mb-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="mb-2">
                                    <h4 class="mb-1 d-flex align-items-center flex-wrap">Coral Cruiser<span
                                    ...
                                    <div class="d-flex align-items-center flex-wrap">
                                        <p class="fs-14 mb-2 me-3 pe-3 border-end"><i
                                                class="isax isax-ship me-2"></i>Luxury Cruise</p>
                                        <p class="fs-14 mb-2 me-3 pe-3 border-end"><i
                                                class="isax isax-location5 me-2"></i>Ciutat Vella, Barcelona<a
                                                href="#location"
                            ...
                            <div class="service-wrap mb-4">
                                <div class="slider-wrap">
                                    <div class="owl-carousel service-carousel nav-center mb-4" id="large-img">
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cruise/cruise-large-01.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cruise/cruise-large-02.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cruise/cruise-large-04.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cruise/cruise-large-05.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cruise/cruise-large-06.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                    </div>
                                    <a href="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}" data-fancybox="gallery"
                                ...
                                <div class="owl-carousel slider-nav-thumbnails nav-center" id="small-img">
                                    <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-01.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-02.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-03.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-04.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-05.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-06.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0 mb-4">
                            ...
                            <div id="accordion_collapse_two" class="accordion-collapse collapse show">
                                <div class="accordion-body">
                                    <p class="mb-2">Kicking off on April 1, 2025, the "DreamsTour" will take Luna to
                                        major cities across North America and Europe, including Los Angeles, New York,
                                        Chicago, Toronto, and London. Each concert will showcase her unique blend
                                        of pop and ethereal soundscapes, bringing her music to life in a way you've
                                        never seen before.
                                    </p>
                                                ...
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="{{url('cruise-details')}}">
                                                            <img src="{{URL::asset('build/img/cruise/cruise-04.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="place-content pb-1">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate">
                                                            <a href="{{url('cruise-details')}}">Balcony</a>
                                                        </h5>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <p class="mb-2 d-inline-flex align-items-center fs-14"><i
                                                            class="isax isax-tick-circle5 text-success me-2"></i>Butler
                                                        Service</p>
                                                    <p class="me-2 mb-2 d-inline-flex align-items-center fs-14"><i
                                                            class="isax isax-tick-circle5 text-success me-2"></i>Laundry
                                                        Services</p>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2"> LED
                                                        TV 2</span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2"> Refrigerator</span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Balcony
                                                    </span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">15
                                                        m²</span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Free
                                                        WiFi</span>
                                                    <span
                                                ...
                                                <div
                                                    ...
                                                    <h5 class="text-primary me-2 mb-3">$252 <span
                                                            class="text-default text-decoration-line-through">$252</span>
                                                        <span class="fs-14 fw-normal text-default">/ Night ( $759 total
                                                            includes taxes & fees)</span>
                                                    </h5>
                                        ...
                                        <div class="place-item mb-4">
                                            <div class="place-img">
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="{{url('cruise-details')}}">
                                                            <img src="{{URL::asset('build/img/cruise/cruise-06.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="place-content pb-1">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate">
                                                            <a href="{{url('cruise-details')}}">Ocean View</a>
                                                        </h5>
                                                    </div>
                                                    <div class="d-flex align-items-center text-nowrap mb-2">
                                                        <span
                                                ...
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <p class="me-2 mb-2 d-inline-flex align-items-center fs-14"><i
                                                            class="isax isax-tick-circle5 text-success me-2"></i>Unlimited
                                                        Wi-Fi</p>
                                                    <p class="mb-2 d-inline-flex align-items-center fs-14"><i
                                                            class="isax isax-tick-circle5 text-success me-2"></i>Private
                                                        Dining</p>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <span
                                                ...
                                                <div
                                                    class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                    <h5 class="text-primary me-2 mb-3">$658 <span
                                                            class="text-default text-decoration-line-through">$252</span>
                                                        <span class="fs-14 fw-normal text-default">/ Night ( $759 total
                                                            includes taxes & fees)</span>
                                                    </h5>
                                        ...
                                        <div class="place-item mb-0">
                                            <div class="place-img">
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="{{url('cruise-details')}}">
                                                            <img src="{{URL::asset('build/img/cruise/cruise-14.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="place-content pb-1">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate">
                                                            <a href="{{url('cruise-details')}}">Suite</a>
                                                        </h5>
                                                    </div>
                                                    <div class="d-flex align-items-center text-nowrap mb-2">
                                                        <span
                                        ...
                                        <div class="d-flex align-items-center flows-step">
                                            ...
                                            <div class="flow-content">
                                                <div
                                                    ...
                                                    <span
                                                        class="avatar avatar-lg avatar-rounded flex-shrink-0 mb-1"><img
                                                            src="{{URL::asset('build/img/tours/tours-16.jpg')}}" alt="Img"></span>
                                                </div>
                                                <p>The tour launches with a spectacular concert at The Hollywood Bowl,
                                                    where Luna will debut her latest hits amidst a breathtaking backdrop
                                                    of lights and visuals.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center flows-step">
                                            ...
                                            <div class="flow-content">
                                                ...
                                                <p>Fans in Seattle and Portland can look forward to intimate
                                                    performances, complete with fan meet-and-greets that allow for
                                                    personal connections with Luna.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center flows-step">
                                            ...
                                            <div class="flow-content">
                                                ...
                                                <p>The tour moves to Chicago, where Luna will perform at the iconic
                                                    United Center. Expect a night filled with energy and emotion as she
                                                    shares her music with devoted fans.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center flows-step">
                                            ...
                                            <div class="flow-content">
                                                ...
                                                <p>
                                                    The New York show at Madison Square Garden promises to be a
                                                    highlight of the tour, featuring special guests and surprises. Luna
                                                    will also engage with fans in Central Park, offering a chance for
                                    ...
                                    <div class="row row-cols-lg-6 row-cols-sm-4 row-cols-2 g-2">
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/cruise/cruise-large-01.jpg')}}">
                                                <img src="{{URL::asset('build/img/cruise/cruise-thumb-01.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/cruise/cruise-large-02.jpg')}}">
                                                <img src="{{URL::asset('build/img/cruise/cruise-thumb-02.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}">
                                                <img src="{{URL::asset('build/img/cruise/cruise-thumb-03.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/cruise/cruise-large-04.jpg')}}">
                                                <img src="{{URL::asset('build/img/cruise/cruise-thumb-04.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/cruise/cruise-large-05.jpg')}}">
                                                <img src="{{URL::asset('build/img/cruise/cruise-thumb-05.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <div
                                                class="galley-wrap more-gallery d-flex align-items-center justify-content-center">
                                                <a data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-04.jpg')}}"
                                                    class="btn btn-white btn-xs"><i
                                                        class="isax isax-image5 me-1"></i>See All</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-body">
                                    <div class="position-relative">
                                        ...
                                        <a href="https://www.youtube.com/watch?v=4fMuE_t5YL4" data-fancybox=""
                                            class="avatar play-video rounded-circle circle-middle">
                                        ...
                                        <div class="card review-item shadow-none mb-3">
                                            <div class="card-body p-3">
                                                <div class="review-info">
                                                    ...
                                                    <p class="mb-2">It was a good location however the cocoon concept
                                                        was weird. No tables, chairs etc was difficult as everything
                                                        went on the floor.</p>
                                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card review-item shadow-none mb-3">
                                            <div class="card-body p-3">
                                                <div class="review-info">
                                                    ...
                                                    <p class="mb-2">From the moment we arrived, the staff made us feel
                                                        welcome. The rooms were immaculate, and every detail was
                                                        thoughtfully arranged. It was the perfect blend of comfort and
                                                        luxury!</p>
                                                    <div class="d-inline-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center fs-14 me-3"><i
                                        ...
                                        <div class="card review-item shadow-none mb-3">
                                            <div class="card-body p-3">
                                                <div class="review-info">
                                                    ...
                                                    <p class="mb-2">The location was perfect for exploring the city, and
                                                        the views from our room were breathtaking. It made our trip so
                                                        much more enjoyable to stay somewhere central and scenic</p>
                                                    <div class="d-inline-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center fs-14 me-3"><i
                    ...
                    <div class="card shadow-none">
                        <div class="card-body">
                            ...
                            <div
                                ...
                                <h5 class="text-primary">$500 <span class="fs-14 text-default fw-normal">/ Night</span>
                                </h5>
                            </div>
                            <div class="banner-form">
                                <form action="{{url('cruise-booking')}}" class="form-info border-0">
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary btn-lg search-btn ms-0 w-100 mb-3 fs-14">Book
                                        Now</button>
                                    <div class="d-flex align-items-center justify-content-between mt-1">
                                        <h6 class="fs-14 fw-medium text-success">3 Cabin Available on your Search</h6>
                                        <a href="#accordion_collapse_six"
                                            class="link-primary text-decoration-underline fs-14">View Cabins</a>
                                    </div>
                                </form>
                            </div>
                        </div>
