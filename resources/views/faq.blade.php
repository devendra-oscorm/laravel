                                ...
                                <div class="accordion " id="accordionFaq">
                                    <div class="accordion-item show  mb-3 pb-3 wow fadeInUp" data-wow-delay="0.2s">
                                        ...
                                        <div id="faq-collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <p class="mb-0">We offer a wide range of tours, including cultural,
                                                    adventure, luxury, and customized itineraries.</p>
                                    ...
                                    <div class="accordion-item  mb-3 wow fadeInUp" data-wow-delay="0.4s">
                                        ...
                                        <div id="faq-collapsetwo" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionFaq">
                                            <div class="accordion-body">
                                                <p>We offer a wide range of tours, including cultural, adventure,
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="que-sec text-center">
                        ...
                        <p class="mb-3">If you cannot find answer to your question in our FAQ, you can always contact
                            us. We wil answer to you shortly!</p>
                        <div class="d-flex justify-content-center">
                            <a href="{{url('contact-us')}}"
                                class="btn btn-primary d-flex align-items-center justify-content-center">Contact Us<i
