                            ...
                            <form action="#">
                                ...
                                <div class="accordion accordion-list">
                                                ...
                                                <div class="more-content">
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cabin1"
                                                            type="checkbox" id="cabin1" checked>
                                                    ...
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cabin2"
                                                            type="checkbox" id="cabin2" checked>
                                                    ...
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cabin7"
                                                            type="checkbox" id="cabin7">
                                                ...
                                                <div class="more-content">
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="amenity1"
                                                            type="checkbox" id="amenity1" checked>
                                                    ...
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="amenity3"
                                                            type="checkbox" id="amenity3" checked>
                                    ...
                                    <div class="accordion-item border-bottom p-3 pb-2">
                                        <div class="accordion-header">
                                            <div class="accordion-button p-0" data-bs-toggle="collapse"
                                                data-bs-target="#accordion-daylist" aria-expanded="true"
                                                aria-controls="accordion-daylist" role="button">
                                        ...
                                        <div id="accordion-daylist" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="">
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="daylist1"
                                                            type="checkbox" id="daylist1">
                                                        <label class="form-check-label ms-2" for="daylist1">
                                                            1 - 2 days
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="daylist2"
                                                            type="checkbox" id="daylist2">
                                                        <label class="form-check-label ms-2" for="daylist2">
                                                            3 - 5 days
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="daylist3"
                                                            type="checkbox" id="daylist3">
                                                        <label class="form-check-label ms-2" for="daylist3">
                                                            6 - 9 days
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="daylist4"
                                                            type="checkbox" id="daylist4">
                                    ...
                                    <div class="accordion-item border-bottom p-3">
                                        <div class="accordion-header">
                                            <div class="accordion-button p-0" data-bs-toggle="collapse"
                                                data-bs-target="#accordion-cruise" aria-expanded="true"
                                                aria-controls="accordion-cruise" role="button">
                                        ...
                                        <div id="accordion-cruise" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="more-content">
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cruise1"
                                                            type="checkbox" id="cruise1" checked>
                                                        <label class="form-check-label ms-2" for="cruise1">
                                                            Luxury Cruise
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cruise2"
                                                            type="checkbox" id="cruise2" checked>
                                                        <label class="form-check-label ms-2" for="cruise2">
                                                            Adventure Cruise
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cruise3"
                                                            type="checkbox" id="cruise3">
                                                        <label class="form-check-label ms-2" for="cruise3">
                                                            Expedition Cruise
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cruise4"
                                                            type="checkbox" id="cruise4" checked>
                                                        <label class="form-check-label ms-2" for="cruise4">
                                                            River Cruise
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cruise5"
                                                            type="checkbox" id="cruise5">
                                                        <label class="form-check-label ms-2" for="cruise5">
                                                            Family Cruise
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cruise6"
                                                            type="checkbox" id="cruise6">
                                    ...
                                    <div class="accordion-item border-bottom p-3 pb-2">
                                        ...
                                        <div id="accordion-guests" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="">
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="guests1"
                                                            type="checkbox" id="guests1">
                                                        <label class="form-check-label ms-2" for="guests1">
                                                            1 - 5
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="guests2"
                                                            type="checkbox" id="guests2">
                                                        <label class="form-check-label ms-2" for="guests2">
                                                            5 - 10
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="guests3"
                                                            type="checkbox" id="guests3">
                                                        <label class="form-check-label ms-2" for="guests3">
                                                            10 - 15
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="guests4"
                                                            type="checkbox" id="guests4">
                                                        <label class="form-check-label ms-2" for="guests4">
                                                            15 - 20
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="guests5"
                                                            type="checkbox" id="guests5">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                ...
                                <a href="{{url('cruise-list')}}" class="list-icon active me-2"><i
                    ...
                    <div class="bg-info br-10 p-3 pb-2 mb-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                            <p class="fs-14 fw-medium mb-2 d-inline-flex align-items-center"><i
                                    class="isax isax-info-circle me-2"></i>Save an average of 15% on thousands of cruise
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="place-item mb-4">
                                        ...
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-05.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-02.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-03.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div>
                                                <h5 class="mb-1 text-truncate"><a href="{{url('cruise-details')}}">Super
                                                        Aquamarine</a></h5>
                                                <p class="d-flex align-items-center fs-14"><i
                                        ...
                                        <p class="fs-14 line-ellipsis mb-3">Embark on a luxurious cruise where
                                            breathtaking destinations meet world-class comfort and entertainment.</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between cruise-list-item border-top flex-wrap row-gap-2 pt-3 mb-3">
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span
                                                    class="text-dark fw-medium">2021</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span
                                            ...
                                            <p class="fs-14"><i class="isax isax-flash-1 me-1"></i>Speed : <span
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-12.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-09.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-07.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span
                                                    class="text-dark fw-medium">2020</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider  owl-carousel nav-center h-100">
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-09.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-01.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-08.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-07.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span
                                                    class="text-dark fw-medium">2017</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span
                                                    class="text-dark fw-medium">4</span></p>
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-fatrows text-gray-6 me-1"></i>Width : <span
                                                    class="text-dark fw-medium">75.12 m</span></p>
                                            <p class="fs-14"><i class="isax isax-flash-1 me-1"></i>Speed : <span
                                                    class="text-dark fw-medium">20 Knots</span></p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <h6 class="d-flex align-items-center"><i
                                                    class="isax isax-home-wifi ms-2 me-2"></i><i
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-10.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span
                                                    class="text-dark fw-medium">2016</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider  owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-01.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span
                                                    class="text-dark fw-medium">2023</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span
                                                    class="text-dark fw-medium">2</span></p>
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-fatrows text-gray-6 me-1"></i>Width : <span
                                                    class="text-dark fw-medium">72.83 m</span></p>
                                            <p class="fs-14"><i class="isax isax-flash-1 me-1"></i>Speed : <span
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider  owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-11.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('cruise-details')}}">
                                                    <img src="{{URL::asset('build/img/cruise/cruise-08.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span
                                                    class="text-dark fw-medium">2018</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span
                                                    class="text-dark fw-medium">3</span></p>
                                            <p class="fs-14 mb-0"><i
                                                    class="isax isax-fatrows text-gray-6 me-1"></i>Width : <span
