                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('cruise-booking')}}"
                                                class="fs-14 d-inline-flex align-items-center active">Cruise</a>
                                        </li>
                                        <li>
                            ...
                            <div class="list-header d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="dropdown me-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Suite</a>
                                            </li>
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Balcony</a>
                                            </li>
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Mini-Suite</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="dropdown me-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CR-1245</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-15.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Super Aquamarine</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CR-3215</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-06.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Adventure of the Seas</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CR-4581</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-05.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Coral Cruiser</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#pending">#CR-6545</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-12.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Celebrity Cruise</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#cancelled">#CR-3256</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-09.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Princess Cruises</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#cancelled">#CR-3654</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-12.jpg')}}"
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Cunard</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CR-1458</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-25.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Norwegian Cruise</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CR-6589</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-26.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Azamara </a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CR-2315</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-27.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Costa Cruise</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CR-5414</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cruise/cruise-28.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('cruise-details')}}">Oceania Cruises</a></p>
