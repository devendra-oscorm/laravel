        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Car Details</h2>
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                <div>
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2">
                        <p class="fs-14 mb-0 me-3 pe-3 border-end d-inline-flex align-items-center"><span><i
                                    class="isax isax-smart-car text-primary me-2"></i></span>Sedan</p>
                        <p class="fs-14 mb-0 me-3 pe-3 border-end"><i class="isax isax-location5 me-2"></i>Ciutat Vella,
                            Barcelona
                            <a href="#field_seven" class="link-primary text-decoration-underline fw-medium ms-2">View
                                Location</a>
                        </p>
                        <div class="d-flex align-items-center flex-wrap row-gap-2">
                            <p class="fs-14 me-3 mb-0 d-inline-flex align-items-center"><span><i
                                        class="isax isax-tick-circle5 text-success me-1"></i></span>Dropoff</p>
                            <p class="fs-14 me-3 mb-0 d-inline-flex align-items-center"><span><i
                                        class="isax isax-tick-circle5 text-success me-1"></i></span>Airport Pickup</p>
                            <p class="fs-14 mb-0 d-inline-flex align-items-center"><span><i
                                        class="isax isax-tick-circle5 text-success me-1"></i></span>Hourly Package</p>
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                    ...
                    <a href="#" class="btn btn-outline-light btn-sm d-inline-flex align-items-center me-2"><i
                            class="isax isax-heart5 text-danger me-1"></i>Save</a>
                    <span class="badge badge-light text-gray-9 badge-md fs-13 fw-medium rounded-pill me-4">No of
                        Bookings : 96</span>
                    <div>
                            ...
                            <div class="card-body">
                                <div class="slider-wrap vertical-slider vertical-slider-two d-flex align-items-center">
                                    <div class="slider-nav nav-center" id="small-img">
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-01.jpg')}}" class="img-fluid"
                                                alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-02.jpg')}}" class="img-fluid"
                                                alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-03.jpg')}}" class="img-fluid"
                                                alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-04.jpg')}}" class="img-fluid"
                                                alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-05.jpg')}}" class="img-fluid"
                                                alt="Slider Img"></div>
                                    </div>
                                    <div class="slider-for nav-center" id="large-img">
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-01.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-02.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-03.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-04.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-05.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                    </div>
                                    <a href="{{URL::asset('build/img/cars/car-large-01.jpg')}}" data-fancybox="gallery"
                                ...
                                <div class="accordion-body">
                                    <form action="{{url('car-details')}}">
                                        <div class="row">
                                                        ...
                                                        <div class="d-inline-block">
                                                            <div class="rating-selction">
                                                                <input type="radio" name="rating" value="5"
                                                                    id="rating05">
                                                                <label for="rating05"><i
                                                                        class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="4"
                                                                    id="rating04">
                                                                <label for="rating04"><i
                                                                        class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="3"
                                                                    id="rating03">
                                                                <label for="rating03"><i
                                                                        class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="2"
                                                                    id="rating02">
                                                                <label for="rating02"><i
                                                                        class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="1"
                                                                    id="rating01">
                                                                <label for="rating01"><i
                                                                        class="fa-solid fa-star"></i></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Write Your Review <span
                                                            class="text-danger">*</span></label>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-2">
                                <div class="form-check me-3 d-flex mb-2">
                                    <input class="form-check-input me-2" type="radio" name="availability"
                                        id="available_1" checked="">
                                            ...
                                            <div class="form-item dropdown pickup-airport p-3">
                                                ...
                                                <div class="dropdown-menu dropdown-md p-0">
                                                    ...
                                                    <ul>
                                                        <li class="border-bottom">
                                                            <a class="dropdown-item" href="#">
                                                                <h6 class="fs-16 fw-medium">Hartsfield-Jackson Atlanta
                                                                    International</h6>
                                                                <p>USA</p>
                                                            </a>
                                                        </li>
                                                        <li class="border-bottom">
                                                            <a class="dropdown-item" href="#">
                                                                <h6 class="fs-16 fw-medium">Dallas/Fort Worth
                                                                    International</h6>
                                                                <p>USA</p>
                                                            </a>
                                                        </li>
