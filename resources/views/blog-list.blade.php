                            ...
                            <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="blog-info text-center">
                                    <div class="d-inline-flex align-items-center justify-content-center">
                                        ...
                                        <p class="text-white mb-2"><i class="isax isax-calendar-2 me-2"></i>14 May 2025
                                        </p>
                                    </div>
                                    <h5><a href="{{url('blog-details')}}">Top 10 Hidden Gems places in Central Europe in
                                            2025</a></h5>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="blog-info text-center">
                                    <div class="d-inline-flex align-items-center justify-content-center">
                                        ...
                                        <p class="text-white mb-2"><i class="isax isax-calendar-2 me-2"></i>12 May 2025
                                        </p>
                                    </div>
                                    <h5><a href="{{url('blog-details')}}">Exploring the World: Your Ultimate Dream Tour
                                            Itinerary</a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="blog-info text-center">
                                    ...
                                    <h5><a href="{{url('blog-details')}}">New York City, USA - The City That Never Sleeps</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
