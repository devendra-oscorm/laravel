        ...
        <div class="container">
            <div class="place-nav">
                <ul class="nav" role="tablist">
                    <li>
                        <a href="#" class="nav-link active" data-bs-toggle="tab" data-bs-target="#add_flight"
                            aria-selected="true" role="tab">
                            Edit Flight
                        </a>
                    </li>
                    <li>
                        <a href="#" class="nav-link" data-bs-toggle="tab" data-bs-target="#add_cabin"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon-end position-relative">
                                                        <input type="text" class="form-control datetimepicker"
                                                            placeholder="dd/mm/yyyy" value="20/11/2024">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl col-xl-4 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon-end position-relative">
                                                        <input type="text" class="form-control datetimepicker"
                                                            placeholder="dd/mm/yyyy" value="01/12/2024">
                                                        <span class="input-icon-addon">
                                                            <i class="isax isax-calendar"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-xxl col-xl-4 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon-end position-relative">
                                                        <input type="text" class="form-control datetimepicker"
                                                            placeholder="dd/mm/yyyy" value="02/12/2024">
                                                        <span class="input-icon-addon">
                                                            <i class="isax isax-calendar"></i>
                                                        </span>
                                                    </div>
