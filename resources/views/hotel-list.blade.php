                            ...
                            <form action="#">
                                ...
                                <div class="accordion accordion-list">
                                    ...
                                    <div class="accordion-item border-bottom p-3">
                                        <div class="accordion-header">
                                            <div class="accordion-button p-0" data-bs-toggle="collapse"
                                                data-bs-target="#accordion-popular1" aria-expanded="true"
                                        ...
                                        <div id="accordion-cusine" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="more-content">
                                                    ...
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cusine5"
                                                            type="checkbox" id="cusine5">
                                                        <label class="form-check-label ms-2" for="cusine5">
                                                            Indian
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="cusine6"
                                                            type="checkbox" id="cusine6">
                                        ...
                                        <div id="accordion-style" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="more-content">
                                                    ...
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="style6"
                                                            type="checkbox" id="style6">
                                                        <label class="form-check-label ms-2" for="style6">
                                                            Romantic
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="style7"
                                                            type="checkbox" id="style7">
                                    ...
                                    <div class="accordion-item border-bottom p-3">
                                        ...
                                        <div id="accordion-brand" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="more-content">
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="brand1"
                                                            type="checkbox" id="brand1">
                                                        <label class="form-check-label ms-2" for="brand1">
                                                            OYO
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="brand2"
                                                            type="checkbox" id="brand2">
                                                        <label class="form-check-label ms-2" for="brand2">
                                                            Fab Hotels
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="brand3"
                                                            type="checkbox" id="brand3">
                                                        <label class="form-check-label ms-2" for="brand3">
                                                            Treebo
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="brand4"
                                                            type="checkbox" id="brand4" checked>
                                                        <label class="form-check-label ms-2" for="brand4">
                                                            The Park Hotels
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="brand5"
                                                            type="checkbox" id="brand5">
                                                        <label class="form-check-label ms-2" for="brand5">
                                                            Hotel Taj
                                                        </label>
                                                    </div>
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="brand6"
                                                            type="checkbox" id="brand6">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                ...
                                <a href="{{url('hotel-list')}}" class="list-icon active me-2"><i
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="place-item mb-4">
                                        ...
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-01.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-02.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content pb-1">
                                        ...
                                        <p class="line-ellipsis fs-14">Experience luxury and comfort at our centrally
                                            located hotel, featuring modern amenities, spacious rooms, and exceptional
                                            service.</p>
                                        <div
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content pb-1">
                                        ...
                                        <p class="line-ellipsis fs-14">Stay in luxury at our hotel, featuring premium
                                            amenities, stunning cityscape views, and an on-site spa for the ultimate
                                        ...
                                        <div
                                            ...
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    ...
                                                    class="isax isax-wind-2 me-2 text-primary"></i><a href="#"
                                                    class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                            <h5 class="text-primary text-nowrap me-2 mb-3">$600 <span
                                                    class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content pb-1">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div class="overflow-hidden">
                                                <h5 class="mb-1 text-truncate"><a href="{{url('hotel-details')}}">The Urban
                                                        Retreat</a></h5>
                                                <p class="d-flex align-items-center text-truncate mb-2"><i
                                                        class="isax isax-location5 me-2"></i>Princes Street, Edinburgh
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#"
                                        ...
                                        <p class="line-ellipsis fs-14">Conveniently located near top attractions, our
                                            hotel offers modern rooms, free parking, and a complimentary breakfast to
                                        ...
                                        <div
                                            ...
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    ...
                                                    class="isax isax-wind-2 me-2 text-primary"></i><a href="#"
                                                    class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                            <h5 class="text-primary text-nowrap me-2 mb-3">$300 <span
                                                    class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-07.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-03.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content pb-1">
                                        ...
                                        <p class="line-ellipsis fs-14">Discover the perfect balance of luxury and
                                            affordability at our hotel, with a 24-hour concierge, free Wi-Fi, and easy
                                            access to local hotspots.</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    class="isax isax-home-wifi ms-2 me-2 text-primary"></i><i
                                                    ...
                                                    class="isax isax-wind-2 me-2 text-primary"></i><a href="#"
                                                    class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                            <h5 class="text-primary text-nowrap me-2 mb-3">$400 <span
                                                    class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-08.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content pb-1">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div class="overflow-hidden">
                                                <h5 class="mb-1 text-truncate"><a href="{{url('hotel-details')}}">Hotel
                                                        Evergreen </a></h5>
                                                <p class="d-flex align-items-center text-truncate mb-2"><i
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#"
                                                    class="d-flex align-items-center overflow-hidden border-end pe-2 me-2">
                                                    <span class="avatar avatar-md flex-shrink-0 me-2">
                                                        <img src="{{URL::asset('build/img/users/user-06.jpg')}}" class="rounded-circle"
                                                            alt="img">
                                                    </span>
                                        ...
                                        <p class="line-ellipsis fs-14">Our hotel offers pet-friendly rooms,
                                            complimentary shuttle service, and comfortable accommodations just minutes
                                            from key attractions and business centers.</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    class="isax isax-home-wifi ms-2 me-2 text-primary"></i><i
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-10.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-04.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-06.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content pb-1">
                                        ...
                                        <p class="line-ellipsis fs-14">Relax in our elegantly designed rooms with
                                            stunning views, on-site dining, and premium amenities, ideal for both
                                            business and leisure stays</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    class="isax isax-home-wifi ms-2 me-2 text-primary"></i><i
                                                    ...
                                                    class="isax isax-wind-2 me-2 text-primary"></i><a href="#"
                                                    class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                            <h5 class="text-primary text-nowrap me-2 mb-3">$450 <span
                                                    class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-11.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-05.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content pb-1">
                                        ...
                                        <p class="line-ellipsis fs-14">Whether you're here for business or leisure, our
                                            hotel provides modern amenities, free Wi-Fi, and easy access to the city's
                                            vibrant downtown area</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    class="isax isax-home-wifi ms-2 me-2 text-primary"></i><i
                                                    ...
                                                    class="isax isax-wind-2 me-2 text-primary"></i><a href="#"
                                                    class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                            <h5 class="text-primary text-nowrap me-2 mb-3">$350 <span
                                                    class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('hotel-details')}}">
                                                    <img src="{{URL::asset('build/img/hotels/hotel-12.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content pb-1">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div class="overflow-hidden">
                                                <h5 class="mb-1 text-truncate"><a href="{{url('hotel-details')}}">Hotel Aurora
                                                        Bliss</a></h5>
                                                <p class="d-flex align-items-center text-truncate mb-2"><i
                                                        class="isax isax-location5 me-2"></i>Castle Street, Cambridge
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#"
                                        ...
                                        <p class="line-ellipsis fs-14">Stay in the heart of the action at our hotel,
                                            featuring well-appointed rooms, on-site dining, and easy access to popular
                                        ...
                                        <div
                                            ...
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
                                                    ...
                                                    class="isax isax-wind-2 me-2 text-primary"></i><a href="#"
                                                    class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                            <h5 class="text-primary text-nowrap me-2 mb-3">$650 <span
                                                    class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content pb-1">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            <div>
                                                <h5 class="mb-1 text-truncate"><a href="{{url('hotel-details')}}">The
                                                        Skyline</a></h5>
                                                <p class="d-flex align-items-center mb-2"><i
                                                        class="isax isax-location5 me-2"></i>Chapel Street, London</p>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#"
                                                    class="d-flex align-items-center overflow-hidden border-end pe-2 me-2">
                                        ...
                                        <p class="line-ellipsis fs-14">Our hotel has featuring premium amenities,
                                            stunning cityscape views, and an on-site spa for the ultimate relaxation
                                            experience</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                            <h6 class="d-flex align-items-center mb-3">Facillities :<i
