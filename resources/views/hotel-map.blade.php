                            ...
                            <form action="{{url('hotel-grid')}}">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="amenities2" type="checkbox"
                                        id="amenities2">
                                    <label class="form-check-label ms-2" for="amenities2">Airport shuttle
                                        included</label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="amenities9" type="checkbox"
                                        id="amenities9" checked>
                                    <label class="form-check-label ms-2" for="amenities9">Gym</label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="amenities10" type="checkbox"
                                        id="amenities10" checked>
