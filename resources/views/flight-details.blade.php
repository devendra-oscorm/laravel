                        ...
                        <div class="service-wrap slider-wrap-five mb-4">
                            ...
                            <div class="service-wrap mb-4">
                                <div class="slider-wrap">
                                    <div class="owl-carousel service-carousel nav-center mb-4" id="large-img">
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/flight/flight-large-01.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/flight/flight-large-02.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/flight/flight-large-03.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/flight/flight-large-04.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/flight/flight-large-05.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/flight/flight-large-06.jpg')}}" class="img-fluid"
                                                alt="Slider Img">
                                        </div>
                                    </div>
                                    <a href="{{URL::asset('build/img/flight/flight-large-04.jpg')}}" data-fancybox="gallery"
                                ...
                                <div class="owl-carousel slider-nav-thumbnails nav-center" id="small-img">
                                    <div><img src="{{URL::asset('build/img/flight/flight-thumb-01.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/flight/flight-thumb-02.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/flight/flight-thumb-03.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/flight/flight-thumb-04.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/flight/flight-thumb-05.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                    <div><img src="{{URL::asset('build/img/flight/flight-thumb-06.jpg')}}" class="img-fluid"
                                            alt="Slider Img"></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="hotel-list">
                                        <div class="place-item mb-4">
                                                ...
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="{{url('flight-details')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-01.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                    <div class="slide-images">
                                                        <a href="{{url('flight-details')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-02.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="place-content pb-1">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate">
                                                            <a href="{{url('flight-details')}}">Economy Class</a>
                                                        </h5>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <p class="me-3 mb-3 d-inline-flex align-items-center"><i
                                                            class="isax isax-tick-circle5 text-success me-1"></i>Excess
                                                        Baggage</p>
                                                    <p class="mb-3 d-inline-flex align-items-center"><i
                                                            class="isax isax-tick-circle5 text-success me-1"></i>Priority
                                                        Boarding</p>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3"> LED
                                                        TV 2</span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3">15
                                                        m²</span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3">Free
                                                        WiFi</span>
                                                    <span
                                                        class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3">Private
                                                        Safe</span>
                                                </div>
                                                <div
                                                    class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                    <h5 class="text-primary me-2">$500 <span
                                                            class="text-default text-decoration-line-through">$252</span>
                                                        <span class="fs-14 fw-normal text-default">/ Person ( $759 total
                                        ...
                                        <div class="place-item mb-4">
                                            <div class="place-img">
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="{{url('flight-details')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-03.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                    <div class="slide-images">
                                                        <a href="{{url('flight-details')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-04.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="place-content pb-1">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate">
                                                            <a href="{{url('flight-details')}}">Business Class</a>
                                                        </h5>
                                                    </div>
                                                    <div class="d-flex align-items-center text-nowrap mb-2">
                                                        <span
                                                ...
                                                <div
                                                    class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                    <h5 class="text-primary me-2">$500 <span
                                                            class="text-default text-decoration-line-through">$658</span>
                                                        <span class="fs-14 fw-normal text-default">/ Person ( $756 total
                                                            includes taxes & fees )</span>
                                                    </h5>
                                                    <div class="btn btn-primary btn-md">
                                                        <div class="form-check d-flex align-items-center ps-0">
                                        ...
                                        <div class="place-item mb-4">
                                            <div class="place-img">
                                                <div class="img-slider owl-carousel nav-center">
                                                    <div class="slide-images">
                                                        <a href="{{url('flight-details')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-13.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                    <div class="slide-images">
                                                        <a href="{{url('flight-details')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-12.jpg')}}" class="img-fluid"
                                                                alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="place-content pb-1">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <h5 class="mb-2 d-inline-flex align-items-center text-truncate">
                                                            <a href="{{url('flight-details')}}">Regular</a>
                                                        </h5>
                                                    </div>
                                                    <div class="d-flex align-items-center text-nowrap mb-2">
                                                        <span
                                                ...
                                                <div
                                                    class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3 gap-2">
                                                    <h5 class="text-primary me-2">$500 <span
                                                            class="text-default text-decoration-line-through">$989</span>
                                                        <span class="fs-14 fw-normal text-default">/ Person ( $1059
                                                            total includes taxes & fees )</span>
                                                    </h5>
                                                    <div class="btn btn-primary btn-md">
                                                        <div class="form-check d-flex align-items-center ps-0">
                                                            <input
                                                                class="form-check-input ms-0 mt-0 border border-white"
                                                                name="book" type="checkbox" id="book3" checked>
                                                            <label class="form-check-label fs-13 text-white ms-2"
                                    ...
                                    <div class="row row-cols-lg-6 row-cols-sm-4 row-cols-2 g-2">
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/flight/flight-large-01.jpg')}}">
                                                <img src="{{URL::asset('build/img/flight/flight-thumb-01.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/flight/flight-large-02.jpg')}}">
                                                <img src="{{URL::asset('build/img/flight/flight-thumb-02.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/flight/flight-large-03.jpg')}}">
                                                <img src="{{URL::asset('build/img/flight/flight-thumb-03.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/flight/flight-large-04.jpg')}}">
                                                <img src="{{URL::asset('build/img/flight/flight-thumb-04.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="galley-wrap" data-fancybox="gallery"
                                                href="{{URL::asset('build/img/flight/flight-large-05.jpg')}}">
                                        ...
                                        <div class="col">
                                            <div
                                                ...
                                                <a data-fancybox="gallery" href="{{URL::asset('build/img/flight/flight-large-01.jpg')}}"
                                                ...
                                                <div class="review-info">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery"
                                                            href="{{URL::asset('build/img/flight/flight-large-04.jpg')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-thumb-04.jpg')}}"
                                                                class="br-10" alt="img">
                                                        </a>
                                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery"
                                                            href="{{URL::asset('build/img/flight/flight-large-02.jpg')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-thumb-02.jpg')}}"
                                                                class="br-10" alt="img">
                                                        </a>
                                                        <a class="avatar avatar-md me-0 mb-2" data-fancybox="gallery"
                                                            href="{{URL::asset('build/img/flight/flight-large-03.jpg')}}">
                                                            <img src="{{URL::asset('build/img/flight/flight-thumb-03.jpg')}}"
                                                                class="br-10" alt="img">
                                                        </a>
                                                    </div>
