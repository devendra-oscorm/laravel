                    ...
                    <div class="dropdown mb-3">
                        ...
                        <div class="dropdown-menu dropdown-sm">
                            <form action="{{url('cruise-map')}}">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="amenities6" type="checkbox"
                                        id="amenities6">
                                    <label class="form-check-label ms-2" for="amenities6">Complimentary meals</label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="amenities7" type="checkbox"
                                        id="amenities7">
                                    <label class="form-check-label ms-2" for="amenities7">Air conditioned</label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="amenities8" type="checkbox"
                                        id="amenities8" checked>
                                    <label class="form-check-label ms-2" for="amenities8">Play Areas</label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-0">
                                    <input class="form-check-input ms-0 mt-0" name="amenities11" type="checkbox"
                                        id="amenities11" checked>
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <h6 class="d-flex align-items-center"><i
                                                    class="isax isax-home-wifi me-2"></i><i
