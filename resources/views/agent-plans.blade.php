...
@section('content')
    ...
    <div class="content">
        <div class="container">
            <div class="mb-3">
                <a href="{{url('agent-plans-settings')}}" class="text-primary d-inline-flex align-items-center fs-14"><i
                        class="isax isax-arrow-left me-2"></i>Back to Plans & Billings</a>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="text-end">
                        <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                            data-bs-target="#payment_success">Proceed to Pay $99.00</a>
                    </div>
                </div>
