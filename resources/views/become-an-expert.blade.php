        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Become an Expert</h2>
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="section-header text-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p>Discover how easy it is to become a travel expert. Follow these steps to share your knowledge
                            and earn rewards!</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card work-card d-flex mb-0 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card-body flex-fill">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <span
                                    class="work-icon bg-primary-transparent d-flex align-items-center justify-content-between">
                            ...
                            <div class="card-content">
                                ...
                                <p>Create your account by filling out our quick registration form and set up your
                                    profile</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card work-card d-flex mb-0 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card-body flex-fill">
                            ...
                            <div class="card-content">
                                ...
                                <p>Add your service with detailed descriptions and competitive pricing to attract more
                                    customers.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="section-header wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p class="mb-4">Discover how becoming a travel expert can open doors to exciting opportunities,
                            from earning income by sharing your knowledge​</p>
                    </div>
                    <div class="local-expert wow fadeInUp" data-wow-delay="0.2s">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p>Hosting tours can provide a steady source of income, especially in popular tourist
                                    destinations.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p>Get assistance anytime, day or night, ensuring seamless support for your queries or
                                    concerns.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p>Connect with other local businesses, like restaurants, hotels, and transportation
                                    providers, to enhance your offerings.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            <span class="avatar bg-secondary flex-shrink-0 me-3">
                            ...
                            <div>
                                ...
                                <p>Establish yourself as an authority in your community. Gain respect and admiration
                                    from tourists and locals alike.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                            ...
                            <form action="#">
                                ...
                                <div class="form-check d-flex mb-3">
                                    ...
                                    <label class="form-check-label ms-2 text-gray-9 fs-14" for="remembers_me">
                                        I have read and accept the <a href="{{url('terms-conditions')}}"
                                            class="text-primary text-decoration-underline">Terms and conditions</a>
                                         and <a href="{{url('privacy-policy')}}"
                                            class="text-primary text-decoration-underline">Privacy policy</a>
                                    </label>
                                </div>
                                <button type="submit"
                                    class="btn btn-primary btn-lg d-flex align-items-center justify-content-center">Send
                                    Message</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="text-center section-header mb-4">
                        ...
                        <p>DreamsTour, a tour operator specializing in dream destinations, offers a variety of benefits
                            for travelers.</p>
                    </div>
                            ...
                            <div id="faq-collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <p class="mb-0">We offer a wide range of tours, including cultural, adventure,
                                        luxury, and customized itineraries. Popular destinations include Europe, Africa
                                        (e.g., Morocco), </p>
                                </div>
                            </div>
                        </div>
