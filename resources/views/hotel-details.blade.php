            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                        <div class="mb-2">
                            <h4 class="mb-1 d-flex align-items-center flex-wrap">Hotel Plaza Athenee<span
                                    class="badge badge-xs bg-success rounded-pill ms-2"><i
                                        class="isax isax-ticket-star me-1"></i>Verified</span></h4>
                            <div class="d-flex align-items-center flex-wrap">
                                <p class="fs-14 mb-2 me-3 pe-3 border-end"><i class="isax isax-buildings me-2"></i>Hotel
                                </p>
                                <p class="fs-14 mb-2 me-3 pe-3 border-end"><i
                                        class="isax isax-location5 me-2"></i>Barcelona<a href="#location"
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                        <div class="d-flex align-items-center flex-wrap">
                            <p class="fs-14 me-2 mb-2"><i class="isax isax-tick-circle5 text-success me-2"></i>Fully
                                refundable</p>
                            <p class="fs-14 me-2 mb-2"><i class="isax isax-tick-circle5 text-success me-2"></i>Express
                                check-in/out available</p>
                            <p class="fs-14 mb-2"><i class="isax isax-tick-circle5 text-success me-2"></i>Minimum
                                check-in age: 18</p>
                        </div>
                        <span class="badge badge-light text-gray-9 badge-md fs-13 fw-medium rounded-pill mb-2">Total 48
                            Rooms </span>
                    </div>
                    <div class="border-bottom pb-4 mb-4">
                        <div class="service-wrap mb-4">
                            <div class="slider-wrap">
                                <div class="owl-carousel service-carousel nav-center mb-4" id="large-img">
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/hotels/hotel-large-01.jpg')}}" class="img-fluid"
                                            alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/hotels/hotel-large-02.jpg')}}" class="img-fluid"
                                            alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/hotels/hotel-large-03.jpg')}}" class="img-fluid"
                                            alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/hotels/hotel-large-04.jpg')}}" class="img-fluid"
                                            alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/hotels/hotel-large-05.jpg')}}" class="img-fluid"
                                            alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/hotels/hotel-large-06.jpg')}}" class="img-fluid"
                                            alt="Slider Img">
                                    </div>
                                </div>
                                <a href="{{URL::asset('build/img/hotels/hotel-large-02.jpg')}}" data-fancybox="gallery"
                            ...
                            <div class="owl-carousel slider-nav-thumbnails nav-center" id="small-img">
                                <div><img src="{{URL::asset('build/img/hotels/hotel-thumb-01.jpg')}}" class="img-fluid" alt="Slider Img">
                                </div>
                                <div><img src="{{URL::asset('build/img/hotels/hotel-thumb-02.jpg')}}" class="img-fluid" alt="Slider Img">
                                </div>
                                <div><img src="{{URL::asset('build/img/hotels/hotel-thumb-03.jpg')}}" class="img-fluid" alt="Slider Img">
                                </div>
                                <div><img src="{{URL::asset('build/img/hotels/hotel-thumb-04.jpg')}}" class="img-fluid" alt="Slider Img">
                                </div>
                                <div><img src="{{URL::asset('build/img/hotels/hotel-thumb-05.jpg')}}" class="img-fluid" alt="Slider Img">
                                </div>
                                <div><img src="{{URL::asset('build/img/hotels/hotel-thumb-06.jpg')}}" class="img-fluid" alt="Slider Img">
                                </div>
                            </div>
                        </div>
                        <h5 class="mb-3 fs-18">Description</h5>
                        <div>
                            <p>Hotel Plaza Athenee is an excellent choice for travellers visiting Coimbatore, offering a
                                budget friendly environment alongside many helpful amenities designed to enhance your
                                stay. The rooms offer a flat screen TV and air
                                conditioning
                            </p>
                        </div>
                        <div class="read-more">
                            <div class="more-text">
                                <p>and getting online is possible, as free internet access is available, allowing you to
                                    rest and refresh with ease.
                                </p>
                            </div>
                    ...
                    <div class="border-bottom pb-4 mb-4">
                        ...
                        <div class="highlight-box">
                            <p class="d-flex align-items-center"><i class="isax isax-star-1 text-orange"></i>Spacious
                                Rooms: Comfortable accommodations with contemporary furnishings and high-quality
                                bedding.</p>
                        </div>
                        <div class="highlight-box">
                            <p class="d-flex align-items-center"><i class="isax isax-star-1 text-orange"></i>Destination
                                Unlocked: Programs that encourage exploration of local culture and attractions.</p>
                        </div>
                        <div class="highlight-box">
                            <p class="d-flex align-items-center"><i
                                    class="isax isax-star-1 text-orange"></i>Sophisticated Décor: Modern and artistic
                                interiors with a touch of elegance.</p>
                        </div>
                    </div>
                    <!-- /Highlights -->
                                                            ...
                                                            <div class="col-md-12">
                                                                <div
                                                                    ...
                                                                    <label class="form-label text-gray-9 mb-2">Infants
                                                                        <span class="text-default fw-normal">( 0-12 Yrs
                                                                            )</span></label>
                                                                    <div class="custom-increment">
                                                                        <div class="input-group">
                                                                            <span class="input-group-btn float-start">
                                ...
                                <div class="place-content pb-1">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                        <div class="overflow-hidden">
                                            <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a
                                                    href="{{url('hotel-details')}}">Queen Room</a><span
                                                    class="badge badge-xs badge-success rounded-pill ms-2">19%
                                                    Offer</span></h5>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap">
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Sleeps
                                            2</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">1
                                            Queen Bed</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">City
                                            View </span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">15
                                            m²</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Free
                                            WiFi</span>
                                        <span
                                            class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Private
                                            Safe</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill mb-2">Free Self
                                            Parking</span>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap">
                                        <p class="me-2 mb-2 d-inline-flex align-items-center"><i
                                                class="isax isax-tick-circle5 text-success me-2"></i>Refundable</p>
                                        <p class="mb-2 d-inline-flex align-items-center"><i
                                                class="isax isax-tick-circle5 text-success me-2"></i>Express
                                            check-in/out available</p>
                                    </div>
                                    <div
                                        class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                        <h5 class="text-primary me-2 mb-3">$500 <span
                                                class="text-default text-decoration-line-through">$654</span> <span
                                                class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        <div class="d-flex align-items-center">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#room-details"
                                                class="fs-14 link-primary text-decoration-underline me-3 mb-3">View Room
                                                Details</a>
                                            <div class="btn btn-primary btn-md mb-3">
                                                <div class="form-check d-flex align-items-center ps-0">
                                                    <input class="form-check-input ms-0 mt-0 border border-white"
                                                        name="book" type="checkbox" id="book1" checked>
                                                    <label class="form-check-label fs-13 text-white ms-2"
                                                        for="book1">Select Room</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content pb-1">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                        <div class="overflow-hidden">
                                            <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a
                                                    href="{{url('hotel-details')}}">Double Room</a></h5>
                                        </div>
                                        <div class="d-flex align-items-center text-nowrap mb-2">
                                            <span
                                    ...
                                    <div class="d-flex align-items-center flex-wrap">
                                        <p class="me-2 mb-2 d-inline-flex align-items-center"><i
                                                class="isax isax-tick-circle5 text-success me-2"></i>Reserve now, pay
                                            later</p>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap mb-2">
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Sleeps
                                            6</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">2 King
                                            Beds</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Family
                                            Room</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">23
                                            m²</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">2
                                            Bathrooms</span>
                                    </div>
                                    <div
                                        class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                        <h5 class="text-primary me-2 mb-3">$700 <span
                                                class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        <div class="d-flex align-items-center">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#room-details"
                                                class="fs-14 link-primary text-decoration-underline me-3 mb-3">View Room
                                            ...
                                            <div class="btn btn-primary btn-md mb-3">
                                                <div class="form-check d-flex align-items-center ps-0">
                                                    <input class="form-check-input ms-0 mt-0 border border-white"
                                                        name="book" type="checkbox" id="book2">
                                                    <label class="form-check-label fs-13 text-white ms-2"
                                                        for="book2">Select Room</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content pb-1">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                        <div class="overflow-hidden">
                                            <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a
                                                    href="{{url('hotel-details')}}">Executive Suite 1Bedroom</a></h5>
                                        </div>
                                        <div class="d-flex align-items-center text-nowrap mb-2">
                                            <span
                                                class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.9</span>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap mb-2">
                                        ...
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Family
                                            Room</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">35
                                            m²</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Free
                                            WiFi</span>
                                        <span
                                            class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2">Private
                                            Safe</span>
                                        <span class="badge badge-info-100 fs-10 fw-medium rounded-pill mb-2">Free
                                            Parking</span>
                                    </div>
                                    <div
                                        class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                        <h5 class="text-primary me-2 mb-3">$450 <span
                                                class="fs-14 fw-normal text-default">/ Night</span></h5>
                                        <div class="d-flex align-items-center">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#room-details"
                                                class="fs-14 link-primary text-decoration-underline me-3 mb-3">View Room
                                            ...
                                            <div class="btn btn-primary btn-md mb-3">
                                                <div class="form-check d-flex align-items-center ps-0">
                                                    <input class="form-check-input ms-0 mt-0 border border-white"
                                                        name="book" type="checkbox" id="book3">
                                                    <label class="form-check-label fs-13 text-white ms-2"
                                                        for="book3">Select Room</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="border-bottom pb-2 mb-4">
                        ...
                        <div class="policy-wrap p-3 pb-2 mb-3">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <a href="#" class="fs-14 fw-medium text-decoration-underline toggle-btn mb-2">Show
                                    Less</a>
                            </div>
                            <div class="policy-info pb-2">
                                <p class="mb-0">- A valid credit card will be required upon booking;</p>
                                <p class="mb-0">- For credit card reservations, the same card(s) must be presented upon
                                    check in at the respective hotels;</p>
                                <p class="mb-0">- Management reserves the right to cancel any reservations without
                                    notice if we are notified of any fraud or illegal activities associated with the
                                    full payments received.</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Wheelchair accessible</p>
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Visual alarms in hallways</p>
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Wheelchair-accessible gym</p>
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Elevator</p>
                            </div>
                            <div class="col-md-6">
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Braille/raised signage</p>
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Wheelchair-accessible business
                                    center</p>
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Wheelchair-accessible lounge</p>
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-magic-star fs-14 me-2"></i>Wheelchair-accessible concierge desk
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card review-item shadow-none mb-3">
                            <div class="card-body p-3">
                                <div class="review-info">
                                    ...
                                    <p class="mb-2">This hotel exceeded my expectations! The pool, spa, and dining
                                        options were top-notch, and the room had every amenity I could ask for. It felt
                                        like a true getaway.</p>
                                    <div class="d-flex align-items-center">
                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery"
                                            href="{{URL::asset('build/img/hotels/hotel-large-07.jpg')}}">
                                            <img src="{{URL::asset('build/img/hotels/hotel-gallery-01.jpg')}}" alt="img">
                                        </a>
                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery"
                                            href="{{URL::asset('build/img/hotels/hotel-large-08.jpg')}}">
                                            <img src="{{URL::asset('build/img/hotels/hotel-gallery-02.jpg')}}" alt="img">
                                        </a>
                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery"
                                            href="{{URL::asset('build/img/hotels/hotel-large-09.jpg')}}">
                        ...
                        <div class="card review-item shadow-none mb-3">
                            <div class="card-body p-3">
                                <div class="review-info">
                                    ...
                                    <p class="mb-2">From the moment we arrived, the staff made us feel welcome. The
                                        rooms were immaculate, and every detail was thoughtfully arranged. It was the
                                        perfect blend of comfort and luxury!</p>
                                    <div class="d-inline-flex align-items-center">
                                        <a href="#" class="d-inline-flex align-items-center fs-14 me-3"><i
                        ...
                        <div class="card review-item shadow-none mb-3">
                            <div class="card-body p-3">
                                <div class="review-info">
                                    ...
                                    <p class="mb-2">The location was perfect for exploring the city, and the views from
                                        our room were breathtaking. It made our trip so much more enjoyable to stay
                                        somewhere central and scenic</p>
                                    <div class="d-inline-flex align-items-center">
                                        <a href="#" class="d-inline-flex align-items-center fs-14 me-3"><i
                                ...
                                <div class="review-info reply mt-4 p-3">
                                    ...
                                    <p class="mb-2">Thank you so much for your kind words! We're thrilled to hear that
                                        our location and views made your trip even more enjoyable. We hope to welcome
                                        you back soon for another scenic stay!</p>
                                    <div class="d-inline-flex align-items-center">
                                        <a href="#" class="d-inline-flex align-items-center fs-14 me-3"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="banner-form">
                                <form action="{{url('hotel-booking')}}">
                                        ...
                                        <div class="card shadow-none mb-3">
                                            <div class="card-body p-3 pb-0">
                                                ...
                                                <div class="custom-increment">
                                                    ...
                                                    <div class="mb-3 d-flex align-items-center justify-content-between">
                                                        <label class="form-label text-gray-9">Infants <span
                                                                class="text-default fw-normal mb-0">( 0-12 Yrs
                                                                )</span></label>
                                                        <div class="custom-increment">
                                                            <div class="input-group">
                                                                <span class="input-group-btn float-start">
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary btn-lg search-btn ms-0 mb-3 w-100 fs-14">Book
                                        Now</button>
                                </form>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-1">
                                <p class="fs-14 text-dark d-inline-flex align-items-center mb-0"><i
                                        class="isax isax-eye me-2"></i>400 Views</p>
                                <a href="#availability" class="link-primary text-decoration-underline fs-14">View
                                    Rooms</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-none" id="location">
                        ...
                        <div class="card-body">
                            <div class="mb-1 d-flex align-items-center justify-content-between flex-wrap">
                                <p class="d-flex align-items-center mb-3"><i
                                        class="isax isax-location5 me-2"></i>15,Adri Street,Ciutat Vella,Barcelona</p>
                            </div>
                            <h5 class="mb-3 fs-18">Nearby Landmarks & Visits</h5>
                            <p class="d-flex align-items-center mb-2"><i class="isax isax-tick-circle me-2"></i>Near By
                                Statue of Liberty</p>
                            <p class="d-flex align-items-center mb-2"><i class="isax isax-tick-circle me-2"></i>The
                                Metropolitan Museum of Art</p>
                            <p class="d-flex align-items-center mb-0"><i
                                    class="isax isax-tick-circle me-2"></i>Yellowstone National Park</p>
                        </div>
                    </div>
                    <!-- /Map -->
