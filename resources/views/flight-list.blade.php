                                    ...
                                    <div class="d-flex  form-info">
                                        <div class="form-item dropdown">
                                            <div>
                                                ...
                                                <input type="text" name="from_city" class="form-control flight-city-autocomplete" value="New York" data-subtitle="#flight-list-from-subtitle">
                                                <p class="fs-12 mb-0" id="flight-list-from-subtitle">Ken International Airport</p>
                                            </div>
                                        ...
                                        <div class="form-item dropdown ps-2 ps-sm-3">
                                            <div>
                                                ...
                                                <input type="text" name="to_city" class="form-control flight-city-autocomplete" value="Las Vegas" data-subtitle="#flight-list-to-subtitle">
                                                <p class="fs-12 mb-0" id="flight-list-to-subtitle">Martini International Airport</p>
                                                <span
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                ...
                                <a href="{{url('flight-list')}}" class="list-icon active me-2"><i
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="place-item mb-4">
                                        ...
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('flight-details')}}">
                                                    <img src="{{URL::asset('build/img/flight/flight-09.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('flight-details')}}">
                                                    <img src="{{URL::asset('build/img/flight/flight-05.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('flight-details')}}">
                                                    <img src="{{URL::asset('build/img/flight/flight-07.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <p class=" fs-14 mb-3">Experience top-notch service, in-flight amenities, and
                                            smooth takeoffs for a stress-free journey.</p>
                                        <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                            ...
                                            <a href="#" class="arrow-icon flex-shrink-0 mx-2"><i
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Aug 01, 2024 - Aug 03,
                                                    2024</p>
                                            </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider image-slide owl-carousel nav-center">
                                            <div class="slide-images">
                                                <a href="{{url('flight-details')}}">
                                                    <img src="{{URL::asset('build/img/flight/flight-08.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('flight-details')}}">
                                                    <img src="{{URL::asset('build/img/flight/flight-06.jpg')}}" class="img-fluid"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <p class=" fs-14 mb-3">Enjoy a comfortable and seamless journey with top-notch
                                            service on every flight.</p>
                                        <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                            <span
                                                class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Aug 13, 2024 - Aug 15,
                                                    2024</p>
                                            </div>
                                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From
                                                </span>$600</h6>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        <div
                                            class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-3">
                                            <div>
                                                <h5 class="text-truncate mb-1"><a href="{{url('flight-details')}}">Nimbus
                                                        345</a></h5>
                                                <div class="d-flex">
                                                    <span class="avatar avatar-sm me-2">
                                                        <img src="{{URL::asset('build/img/icons/airindia.svg')}}" class="rounded-circle"
                                        ...
                                        <p class=" fs-14 mb-3">Enjoy a hassle-free journey with reliable service,
                                            spacious seating, and friendly staff.</p>
                                        <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                            <span
                                                class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Aug 26, 2024 - Aug 27,
                                                    2024</p>
                                            </div>
                                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From
                                                </span>$300</h6>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <p class=" fs-14 mb-3">Travel smart with affordable fares, seamless connections,
                                            and exceptional in-flight comfort.</p>
                                        <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                            <span
                                                class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Sep 04, 2024 - Sep 07,
                                                    2024</p>
                                            </div>
                                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From
                                                </span>$300</h6>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Sep 11, 2024 - Sep 13,
                                                    2024</p>
                                            </div>
                                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From
                                                </span>$550</h6>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        <div
                                            class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-3">
                                            <div>
                                                <h5 class="text-truncate mb-1"><a href="{{url('flight-details')}}">Aether
                                                        Express 901</a></h5>
                                                <div class="d-flex">
                                                    <span class="avatar avatar-sm me-2">
                                                        <img src="{{URL::asset('build/img/icons/airindia.svg')}}" class="rounded-circle"
                                        ...
                                        <p class=" fs-14 mb-3">Fly with confidence, knowing our comfortable cabins and
                                            efficient service make every trip a breeze.</p>
                                        <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                            <span
                                                class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Sep 22, 2024 - Sep 24,
                                                    2024</p>
                                            </div>
                                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From
                                                </span>$450</h6>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        <div
                                            class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-3">
                                            <div>
                                                <h5 class="text-truncate mb-1"><a href="{{url('flight-details')}}">Voyager
                                                        658</a></h5>
                                                <div class="d-flex">
                                                    <span class="avatar avatar-sm me-2">
                                                        <img src="{{URL::asset('build/img/icons/airindia.svg')}}" class="rounded-circle"
                                        ...
                                        <p class=" fs-14 mb-3">Relax and enjoy your flight with on-time schedules,
                                            comfortable seats, and world-class service.</p>
                                        <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                            <span
                                                class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i
                                        ...
                                        <div
                                            ...
                                            <div class="date-info p-2">
                                                <p class="d-flex align-items-center"><i
                                                        class="isax isax-calendar-2 me-2"></i>Oct 04, 2024 - Oct 07,
                                                    2024</p>
                                            </div>
                                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From
                                                </span>$350</h6>
