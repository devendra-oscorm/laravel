<?php $page="agent-pending-payouts";?>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 theiaStickySidebar">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2 mb-3">
                        <a href="{{url('agent-pending-payouts')}}" class="btn btn-primary">Pending Payouts</a>
                        <a href="{{url('agent-payment-history')}}" class="btn btn-light">Payment History</a>
                    </div>
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="dropdown me-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">In Review</a>
                                            </li>
                                            <li>
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-3215</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-3854</a></td>
                                            <td>
