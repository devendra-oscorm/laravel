                            ...
                            <div>
                                ...
                                <div>
                                    <div class="coupoun-list mb-3">
                                        <p class="text-center">Coupon Code <span class="text-gray-9"> Dreams25 ($50)
                                            </span> has been applied successfully <a href="#"
                                                class=" ms-2 text-primary text-decoration-underline">Remove</a> </p>
                                    </div>
                                    <div class="coupoun-list-two">
                                        <p class="text-center">Code Invalid <a href="#"
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center flex-wrap payment-form">
                                    ...
                                    <div class="form-check d-flex align-items-center me-3 mb-2">
                                        <input class="form-check-input mt-0" type="radio" name="Radio" id="paypal"
                                            value="paypal">
                                    ...
                                    <div class="form-check d-flex align-items-center me-3 mb-2">
                                        <input class="form-check-input mt-0" type="radio" name="Radio" id="stripe"
                                            value="stripe">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-4 d-flex">
                                            <div class="card-content flex-fill">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <div>
                                                        <img src="{{URL::asset('build/img/icons/visa-2.svg')}}" alt="image"
                                                            class="img-fluid mb-2">
                                                        <p class="fs-16 fw-medium text-gray-6">**** **** **** 2547</p>
                                                    </div>
                                                    <div class="card-edit-icon">
