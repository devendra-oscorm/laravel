                        ...
                        <div class="card-header user-sidebar-header text-center bg-gray-transparent">
                            ...
                            <div class="d-flex align-items-center justify-content-center notify-item">
                                <a href="{{url('agent-notifications')}}"
                                    class="rounded-circle btn btn-primary text-white d-flex align-items-center justify-content-center p-0 me-2 position-relative">
                    ...
                    <div class="card shadow-none mb-0">
                        ...
                        <div class="card-body">
                                ...
                                <div class="card-body d-sm-flex align-items-center">
                                    ...
                                    <div class="flex-fill">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <a href="#"
                                                class="notification-delete-btn btn btn-primary btn-sm">Delete</a>
                                        </div>
                                        <p class=" mb-1">
                                            You have a new booking request! Check the details and confirm the
                                            reservation.
                            ...
                            <div class="card notification-card">
                                <div class="card-body d-sm-flex align-items-center">
                                    <span
                                        class="avatar avatar-lg rounded-circle bg-danger flex-shrink-0 me-sm-3 mb-3 mb-sm-0">
