        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Edit Hotel</h2>
        ...
        <div class="container">
            <div class="place-nav">
                <ul class="nav" role="tablist">
                    ...
                    <li>
                        <a href="#" class="nav-link" data-bs-toggle="tab" data-bs-target="#add_room"
                            ...
                            <form action="{{url('hotel-grid')}}">
                                ...
                                <div class="card shadow-none" id="faq">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <a href="#" class="btn btn-primary btn-sm add-highlight"
