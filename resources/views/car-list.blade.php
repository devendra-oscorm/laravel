                                ...
                                <div class="accordion accordion-list">
                                                ...
                                                <div class="more-content">
                                                    ...
                                                    <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                        <input class="form-check-input ms-0 mt-0" name="amenity7"
                                                            type="checkbox" id="amenity7" checked>
                                    ...
                                    <div class="accordion-item border-bottom p-3">
                                        ...
                                        <div id="accordion-populars" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                ...
                                                <div class="filter-range-amount">
                                                    <p class="fs-14">Range : <span class="text-gray-9 fw-medium">10000
                                                            Km - 20000 Km</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item border-bottom p-3">
                                        ...
                                        <div id="accordion-brand" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" name="review-1"
                                                        type="checkbox" id="review-1">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" name="review-2"
                                                        type="checkbox" id="review-2">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" name="review-3"
                                                        type="checkbox" id="review-3">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" name="review-4"
                                                        type="checkbox" id="review-4">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-0">
                                                    <input class="form-check-input ms-0 mt-0" name="review-5"
                                                        type="checkbox" id="review-5">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                ...
                                <a href="{{url('car-list')}}" class="list-icon active me-2"><i
                                        ...
                                        <div
                                            ...
                                            <div class="p-2 border rounded d-inline-flex align-items-center">
                                                <div class="d-flex flex-wrap border-end pe-2 me-2">
                                                    <span
                                                        class="fs-14 d-flex align-items-center text-gray-6 fw-normal text-nowrap me-1">
                                            ...
                                            <h5 class="text-primary text-md-end text-nowrap">$500 <span
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <h5 class="text-primary text-md-end text-nowrap">$600 <span
                                                    class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <h5 class="text-primary text-md-end text-nowrap">$300 <span
                                                    class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    ...
                                    <div class="place-content">
                                        ...
                                        <div
                                            ...
                                            <h5 class="text-primary text-md-end text-nowrap">$400 <span
                                                    class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5 class="text-truncate border-end pe-2 me-2"><a
                                                            href="{{url('car-details')}}">Infiniti QX60 </a></h5>
                                                    <span
                                                        class="badge badge-secondary badge-sm d-flex align-items-center">Sedan</span>
                                                </div>
                                                <p class="d-flex align-items-center"><i
                                        ...
                                        <p class="fs-14 mb-3">Spacious and versatile, this car is ideal for families,
                                            offering advanced safety features and a roomy interior for maximum comfort.
                                        </p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 me-1">
                                            <div class="p-2 border rounded d-inline-flex align-items-center">
                                            ...
                                            <h5 class="text-primary text-md-end text-nowrap">$450 <span
                                                    class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5 class="text-truncate border-end pe-2 me-2"><a
                                                            href="{{url('car-details')}}">Toyota 86 Sports</a></h5>
                                                    <span
                                                        class="badge badge-secondary badge-sm d-flex align-items-center">Sedan</span>
                                                </div>
                                                <p class="d-flex align-items-center"><i
                                        ...
                                        <p class="fs-14 mb-3">Compact and efficient, perfect for city driving, this car
                                            boasts excellent fuel economy and easy maneuverability.</p>
                                        <div
                                            class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 me-1">
                                            <div class="p-2 border rounded d-inline-flex align-items-center">
                                                <div class="d-flex flex-wrap border-end pe-2 me-2">
                                            ...
                                            <h5 class="text-primary text-md-end text-nowrap">$350 <span
                                                    class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                        </div>
                                    </div>
                                </div>
