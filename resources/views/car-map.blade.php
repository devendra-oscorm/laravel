                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                                    <div class="d-flex align-items-center flex-wrap">
                                        <div class="form-check d-flex align-items-center me-3 mb-2">
                                            <input class="form-check-input mt-0" type="radio" name="drop" id="same-drop"
                                                value="same-drop" checked>
                                        ...
                                        <div class="form-check d-flex align-items-center me-3 mb-2">
                                            <input class="form-check-input mt-0" type="radio" name="drop" id="airport"
                                                value="airport">
                                        ...
                                        <div class="form-item dropdown pickup-airport">
                                            ...
                                            <div class="dropdown-menu dropdown-md p-0">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="border-bottom">
                                                        <a class="dropdown-item" href="#">
                                                            <h6 class="fs-16 fw-medium">Dallas/Fort Worth International
                                                            </h6>
                                                            <p>USA</p>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <h6 class="fs-16 fw-medium">Singapore Changi International
                                                            </h6>
                                                            <p>Singapore</p>
                                                        </a>
                                                    </li>
                    ...
                    <div class="dropdown mb-3">
                        ...
                        <div class="dropdown-menu dropdown-sm">
                            <form action="{{url('car-map')}}">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="review6" type="checkbox"
                                        id="review6">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-0">
                                    <input class="form-check-input ms-0 mt-0" name="review7" type="checkbox"
                                        id="review7">
                    ...
                    <div class="dropdown mb-3">
                        ...
                        <div class="dropdown-menu dropdown-sm">
                            <form action="{{url('car-map')}}">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="review06" type="checkbox"
                                        id="review06">
                                ...
                                <div class="form-check d-flex align-items-center ps-0 mb-0">
                                    <input class="form-check-input ms-0 mt-0" name="review07" type="checkbox"
                                        id="review07">
                    ...
                    <div class="dropdown mb-3">
                        ...
                        <div class="dropdown-menu dropdown-sm">
                            <form action="{{url('car-map')}}">
                                <h6 class="fw-medium fs-16 mb-3">Pricing</h6>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="pricing01" type="checkbox"
                                        id="pricing01" checked>
                                    <label class="form-check-label ms-2" for="pricing01">
                                        $50 - $100
                                    </label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="pricing02" type="checkbox"
                                        id="pricing02" checked>
                                    <label class="form-check-label ms-2" for="pricing02">
                                        $100 - $1000
                                    </label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                    <input class="form-check-input ms-0 mt-0" name="pricing03" type="checkbox"
                                        id="pricing03" checked>
                                    <label class="form-check-label ms-2" for="pricing03">
                                        $1000 - $5000
                                    </label>
                                </div>
                                <div class="form-check d-flex align-items-center ps-0 mb-0">
                                    <input class="form-check-input ms-0 mt-0" name="pricing04" type="checkbox"
                                        id="pricing04" checked>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="place-item mb-4">
                                        ...
                                        <div class="img-slider car-img owl-carousel nav-center h-100">
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-06.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-07.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-08.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-11.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        ...
                                        <p class="fs-14 mb-3">Enjoy modern comfort, cutting-edge technology, and
                                            exceptional handling for every journey, from city streets to off-road
                                            adventures.</p>
                                        <div class="row align-items-center row-gap-2">
                                            <div class="col-md-9">
                                                <div class="p-2 border rounded d-inline-flex align-items-center">
                                                    <div class="d-flex flex-wrap border-end pe-2 me-2">
                                                        <span
                                                            class="fs-12 d-flex align-items-center text-gray-6 fw-normal text-nowrap me-1">
                                            ...
                                            <div class="col-md-3">
                                                <h5
                                                    class="text-primary d-flex justify-content-start justify-content-lg-end align-items-center flex-wrap">
                                                    $500 <span class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                            </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider car-img owl-carousel nav-center h-100">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-09.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-10.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5 class="text-truncate border-end pe-2 me-2"><a
                                                            href="{{url('car-details')}}">Ford Mustang 4.0 AT</a></h5>
                                                    <span
                                                        class="badge badge-secondary badge-sm d-flex align-items-center">Sedan</span>
                                                </div>
                                                <p class="d-flex align-items-center"><i
                                        ...
                                        <p class="fs-14 mb-3">A powerful and dynamic vehicle, built for those who crave
                                            adventure with a smooth ride and impressive handling.</p>
                                        <div class="row align-items-center row-gap-2">
                                            <div class="col-md-9">
                                                <div class="p-2 border rounded d-inline-flex align-items-center">
                                                    <div class="d-flex flex-wrap border-end pe-2 me-2">
                                            ...
                                            <div class="col-md-3">
                                                <h5
                                                    class="text-primary d-flex justify-content-start justify-content-lg-end align-items-center flex-wrap">
                                                    $600 <span class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider car-img owl-carousel nav-center h-100">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-12.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5 class="text-truncate border-end pe-2 me-2"><a
                                                            href="{{url('car-details')}}">Ferrari 458 MM Special</a></h5>
                                                    <span
                                                        class="badge badge-secondary badge-sm d-flex align-items-center">Sedan</span>
                                                </div>
                                                <p class="d-flex align-items-center"><i
                                        ...
                                        <p class="fs-14 mb-3">Modern and elegant, this car combines innovative features
                                            with a sleek design, offering a premium driving experience.</p>
                                        <div class="row align-items-center row-gap-2">
                                            <div class="col-md-9">
                                                <div class="p-2 border rounded d-inline-flex align-items-center">
                                                    <div class="d-flex flex-wrap border-end pe-2 me-2">
                                            ...
                                            <div class="col-md-3">
                                                <h5
                                                    class="text-primary d-flex justify-content-start justify-content-lg-end align-items-center flex-wrap">
                                                    $300 <span class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5 class="text-truncate border-end pe-2 me-2"><a
                                                            href="{{url('car-details')}}">Mercedes-benz Convertible</a></h5>
                                                    <span
                                                        class="badge badge-secondary badge-sm d-flex align-items-center">Sedan</span>
                                                </div>
                                                <p class="d-flex align-items-center"><i
                                        ...
                                        <p class="fs-14 mb-3">Sleek and stylish, this car offers a blend of performance
                                            and luxury, with cutting-edge technology and a comfortable interior</p>
                                        <div class="row align-items-center row-gap-2">
                                            <div class="col-md-9">
                                                <div class="p-2 border rounded d-inline-flex align-items-center">
                                                    <div class="d-flex flex-wrap border-end pe-2 me-2">
                                            ...
                                            <div class="col-md-3">
                                                <h5
                                                    class="text-primary d-flex justify-content-start justify-content-lg-end align-items-center flex-wrap">
                                                    $400 <span class="fs-14 text-gray-6 fw-normal">/ day</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider car-img owl-carousel nav-center h-100">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-13.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('car-details')}}">
                                                    <img src="{{URL::asset('build/img/cars/car-14.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center mb-1">
                                                    <h5 class="text-truncate border-end pe-2 me-2"><a
                                                            href="{{url('car-details')}}">BMW 3.0 Gran Turismo</a></h5>
                                                    <span
                                                        class="badge badge-secondary badge-sm d-flex align-items-center">Sedan</span>
                                                </div>
                                                <p class="d-flex align-items-center"><i
                                        ...
                                        <p class="fs-14 mb-3">Reliable and fuel-efficient, perfect for daily commutes or
                                            long drives, this car is designed for both convenience and economy.</p>
                                        <div class="row align-items-center row-gap-2">
                                            <div class="col-md-9">
                                                <div class="p-2 border rounded d-inline-flex align-items-center">
                                                    <div class="d-flex flex-wrap border-end pe-2 me-2">
