<?php $page="customer-visa-booking";?>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('customer-visa-booking')}}"
                                                class="fs-14 d-inline-flex align-items-center active">Visa</a>
                                        </li>
                                        <li>
                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="card booking-header">
                        <div
                            ...
                            <div>
                                <h6>Visa Bookings</h6>
                                <p class="fs-14 text-gray-6 fw-normal">No of Bookings : 142</p>
                            </div>
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="dropdown me-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Business Visa</a>
                                            </li>
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Student Visa</a>
                                            </li>
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Work Visa</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="dropdown me-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Applied</a>
                                            </li>
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">On Progress</a>
                                            </li>
                                            <li>
                                                <a href="#" class="dropdown-item rounded-1">Applied</a>
                                            </li>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#applied">#VS-1245</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/visa/visa-01.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Micheal John</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Business Visa</td>
                                            <td>5-7 Days</td>
                                            <td>15 May 2026</td>
                                            <td>
                                                <span
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#applied"><i
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#applied">#VS-3215</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Long term for Academic..</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Student Visa</td>
                                            <td>2-4 weeks</td>
                                            <td>10 May 2026</td>
                                            <td>
                                                <span
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#progress">#VS-4581</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Work Visa for Employment...</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Work Visa</td>
                                            <td>15-20 Days</td>
                                            <td>04 May 2026</td>
                                            <td>
                                                <span
                                                    class="badge badge-secondary rounded-pill d-inline-flex align-items-center fs-10"><i
                                                        class="fa-solid fa-circle fs-5 me-1"></i>On progress</span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#progress"><i
                                                            class="isax isax-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VS-6545</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Short term Visa for...</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Business Visa</td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#applied">#VS-3256</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Family Members to...</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Family Visa</td>
                                            <td>8-12 Days</td>
                                            <td>17 Apr 2026</td>
                                            <td>
                                                <span
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#applied">#VS-3654</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Cultural Programs and...</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Dependent Visa</td>
                                            <td>12-15 Days</td>
                                            <td>02 Sep 2026</td>
                                            <td>
                                                <span
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VS-1458</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Grown up E-visa with...</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Transit Visa</td>
                                            <td>2-3 weeks</td>
                                            <td>20 Oct 2026</td>
                                            <td>
                                                <span
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VS-6589</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Voluntary Work with...</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Work Visa</td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VS-2315</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('visa-details')}}">Skilled Workers with...</a></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-dark mb-0 fw-medium fs-14">Work Visa</td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#progress">#VS-5414</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('visa-details')}}" class="avatar avatar-lg"><img
                                            ...
                                            <td class="text-dark mb-0 fw-medium fs-14">Tourist Visa</td>
                                            <td>2-8 Days</td>
                                            <td>22 Dec 2026</td>
                                            <td>
                                                <span
