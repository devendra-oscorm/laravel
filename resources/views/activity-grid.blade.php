                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                <a href="{{url('activity-grid')}}" class="list-icon active me-2"><i
                                        class="isax isax-grid-1"></i></a>
                                <a href="{{url('activity-list')}}" class="list-icon me-2"><i
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-4 col-md-6 d-flex">
                            <div class="place-item mb-4 flex-fill">
                                <div class="place-img">
                                    <a href="{{url('activity-details')}}">
                                        <img src="{{URL::asset('build/img/activities/activity-09.jpg')}}" class="img-fluid" alt="img">
                                    </a>
                                    <div class="fav-item">
                                        <button class="fav-icon border-0">
                                            <i class="isax isax-heart5"></i>
                                ...
                                <div class="place-content activity-content">
                                    <div class="d-flex align-items-center badge-right position-absolute">
                                        ...
                                        <p class="fs-14 text-gray-2">
                                            <span class="fs-14 fw-medium text-gray-9">5.0</span> (560 reviews)
                                        </p>
                                    </div>
                                    <h5 class="mt-3 mb-1 text-truncate"><a href="{{url('activity-details')}}">Wildlife
                                            Safari</a></h5>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <p class="d-flex align-items-center fs-14 mb-0">
                                            <i class="isax isax-location5 me-1"></i> Kruger, South Africa
                                        </p>
                                        <p class="d-flex align-items-center fs-14 mb-0">
                                            <i class="isax isax-clock5 me-1"></i> 3 hrs
                                        </p>
