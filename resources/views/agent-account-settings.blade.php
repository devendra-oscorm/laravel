                    ...
                    <div class="card settings mb-0">
                        ...
                        <div class="card-body">
                            <div class="settings-link d-flex align-items-center flex-wrap">
                                ...
                                <a href="{{url('agent-account-settings')}}" class="active"><i class="isax isax-wallet-money me-2"></i>Account
                                    Settings</a>
                                ...
                                <a href="{{url('agent-plans-settings')}}"><i class="isax isax-star me-2"></i>Plans &
                                    Billing</a>
                                <a href="{{url('agent-settings-notifications')}}"><i
                                        ...
                                        <div class="card shadow-none bg-gray-transparent">
                                            <div class="card-body">
                                                ...
                                                <form action="{{url('agent-account-settings')}}">
                                                    <div
                                                        class="d-flex align-items-end flex-wrap flex-sm-nowrap row-gap-3">
                                                        <div class="flex-fill">
                                                    ...
                                                    <div class="digit-group">
                                                        <label class="form-label">Enter the code generated by
                                                            Email</label>
                                                        <div class="d-flex align-items-center flex-wrap row-gap-3 mb-2">
                                                            <input type="text" class="form-control me-2" id="digit-1"
                                                                name="digit-1" data-next="digit-2" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-2"
                                                                name="digit-2" data-next="digit-3"
                                                                data-previous="digit-1" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-3"
                                                                name="digit-3" data-next="digit-4"
                                                                data-previous="digit-2" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-4"
                                                                name="digit-4" data-next="digit-5"
                                                                data-previous="digit-3" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-5"
                                                                name="digit-5" data-next="digit-6"
                                                                data-previous="digit-4" maxlength="1">
                                                            <input type="text" class="form-control" id="digit-6"
                                                                name="digit-6" data-next="digit-7"
                                                ...
                                                <form action="{{url('agent-account-settings')}}">
                                                    ...
                                                    <div class="digit-group">
                                                        <label class="form-label">Enter the code generated by
                                                            SMS</label>
                                                        <div class="d-flex align-items-center flex-wrap row-gap-3 mb-2">
                                                            <input type="text" class="form-control me-2" id="digit-7"
                                                                name="digit-7" data-next="digit-8" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-8"
                                                                name="digit-8" data-next="digit-9"
                                                                data-previous="digit-7" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-9"
                                                                name="digit-9" data-next="digit-10"
                                                                data-previous="digit-8" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-10"
                                                                name="digit-10" data-next="digit-11"
                                                                data-previous="digit-9" maxlength="1">
                                                            <input type="text" class="form-control me-2" id="digit-11"
                                                                name="digit-11" data-next="digit-12"
                                                                data-previous="digit-10" maxlength="1">
                                                            <input type="text" class="form-control" id="digit-12"
                                                                name="digit-12" data-next="digit-13"
                                                                data-previous="digit-11" maxlength="1">
                                                        </div>
                                                    </div>
                                                    <button class="btn btn-primary btn-sm" type="submit">Submit</button>
                                                </form>
                                                        ...
                                                        <div class="integration-content">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="icons me-2"><img
                                                                            src="{{URL::asset('build/img/icons/google.svg')}}" alt="icon"
                                                            ...
                                                            <div>
                                                                <p class="fs-14">Used to find travel destinations,
                                                                    accommodations & reviews with ease.</p>
                                                            </div>
                                                            <span class="circle-check-top"><i
                                                                    class="isax isax-tick-circle5 fs-24 text-success"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="integration-content">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="icons me-2"><img
                                                                            src="{{URL::asset('build/img/icons/google-calender.svg')}}"
                                                            ...
                                                            <div>
                                                                <p class="fs-14">Receive reminders for upcoming trips,
                                                                    reservations, and itinerary updates</p>
                                                            </div>
                                                            <span class="circle-check-top"><i
                                                                    class="isax isax-tick-circle5 fs-24 text-success"></i></span>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="integration-content">
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="icons me-2"><img
                                                                            src="{{URL::asset('build/img/icons/google-map.svg')}}"
                                                                            alt="icon" class="img-fluid"></span>
                                                            ...
                                                            <div>
                                                                <p class="fs-14">Provides users with precise directions
                                                                    to destinations and nearby attractions.</p>
                                                            </div>
                                                            <span class="circle-check-top"><i
                                                                    class="isax isax-tick-circle5 fs-24 text-success"></i></span>
                                                        </div>
