<?php $page="agent-business-details";?>
                    ...
                    <div class="card settings mb-0">
                        ...
                        <div class="card-body pb-3">
                            <div class="settings-link d-flex align-items-center flex-wrap">
                                ...
                                <a href="{{url('agent-business-details')}}" class="active"><i
                            ...
                            <form action="{{url('agent-settings')}}">
                                <div class="settings-content mb-3">
                                    ...
                                    <h6 class="fs-16 mb-3">Company Profile</h6>
                                    <div class="row gy-2">
                                        <div class="col-lg-12">
                                            <div class="d-flex align-items-center">
                                                <img src="{{URL::asset('build/img/bg/company.jpg')}}" alt="image"
                                                    class="img-fluid avatar avatar-xxl br-10 flex-shrink-0 me-3">
                                                <div>
                                                    <p class="fs-14 text-gray-6 fw-normal mb-2">Company Logo (400 x 400 pixels)</p>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <label class="form-label">Yeas of Experience</label>
                                                <select class="select">
                                                    <option>Select</option>
                                                    <option>1</option>
                                                    <option>2</option>
