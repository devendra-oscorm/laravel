        ...
        <div class="container">
            <div class="customer-chat">
                <div class="header-navigation">
                    <a href="{{url('agent-dashboard')}}" class="d-inline-flex align-items-center"><i
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="text-end">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <span
                                                    class="msg-count badge badge-primary d-flex align-items-center justify-content-center rounded-circle">2</span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="d-flex justify-content-between chat-member mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="text-end">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <span
                                                    class="msg-count badge badge-primary d-flex align-items-center justify-content-center rounded-circle">3</span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="d-flex justify-content-between chat-member mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="fs-14 text-gray-6 d-flex align-items-center"><i
                        ...
                        <div class="card chat-window mb-0 shadow-none flex-fill">
                            <div class="card-header border-0">
                                <div class="msg_head">
                                    ...
                                    <div class="d-flex align-items-center send-action">
                                        <a href="#" class="btn chat-search-btn send-action-btn" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom" title="Search">
                                            <i class="isax isax-search-normal-14"></i>
                                        </a>
                                        <a class="btn no-bg send-action-btn rounded-circle" href="#"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                            ...
                                            <li><a href="#" class="dropdown-item"><i
                                                        class="isax isax-clock me-2"></i>Disappearing Message</a></li>
                                            <li><a href="#" class="dropdown-item"><i
                                                        class="isax isax-refresh me-2"></i>Clear Message</a></li>
                                            <li><a href="#" class="dropdown-item"><i
                                                        class="isax isax-trash me-2"></i>Delete Chat</a></li>
                                            <li><a href="#" class="dropdown-item"><i
                                                        class="fa-regular fa-thumbs-down me-2"></i>Report</a></li>
                                            <li><a href="#" class="dropdown-item"><i
                                                        class="fa-solid fa-ban me-2"></i>Block</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- Chat Search -->
                                    ...
                                    <form>
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text"><i
                                                    class="isax isax-search-normal-14"></i></span>
                                        </div>
                                    </form>
                                </div>
                                <!-- /Chat Search -->
                            ...
                            <div class="card-body msg_card_body chat-scroll">
                                ...
                                <ul class="list-unstyled">
                                                ...
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center ">
                                                        <div class="received-message me-2">
                                                            <p class="fs-14">Hi! I’m interested in booking a cruise
                                                                tour. Could you help me with some details?</p>
                                                        </div>
                                                        <div class="chat-actions me-2">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end p-3">
                                                                <li><a class="dropdown-item reply-btn" href="#"><i
                                                                            class="isax isax-back-square me-2"></i>Reply</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa-regular fa-share-from-square me-2"></i>Forward</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="isax isax-copy me-2"></i>Copy</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="isax isax-heart me-2"></i>Mark as
                                                                        Favourite</a></li>
                                                                <li><a class="dropdown-item" href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#message-delete"><i
                                                                            class="isax isax-trash me-2"></i>Delete</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa-solid fa-check me-2"></i>Mark as
                                                                        Unread</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="isax isax-archive-1 me-2"></i>Archeive
                                                                        Chat</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa-solid fa-thumbtack me-2"></i>Pin
                                                                        Chat</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <div class="msg-box">
                                                        <div class="d-flex align-items-center justify-content-end mb-1">
                                                            <div>
                                                                <h6 class="fs-16 fw-normal d-flex align-items-center">
                                                                    Chris Foxy</h6>
                                                                <div class="d-flex justify-content-end">
                                                                    <p class="fs-12">9:45 AM <i
                                                                            class="ms-1 text-success fa-solid fa-check-double"></i>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="ms-2">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="chat-actions me-2">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end p-3">
                                                                        ...
                                                                        <li><a class="dropdown-item" href="#"><i
                                                                                    class="isax isax-heart me-2"></i>Mark
                                                                                as Favourite</a></li>
                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#message-delete"><i
                                                                        ...
                                                                        <li><a class="dropdown-item" href="#"><i
                                                                                    class="fa-solid fa-check me-2"></i>Mark
                                                                                as Unread</a></li>
                                                                        <li><a class="dropdown-item" href="#"><i
                                                                                    class="isax isax-archive-1 me-2"></i>Archeive
                                                                                Chat</a></li>
                                                                ...
                                                                <div class="sent-message">
                                                                    <p class="fs-14">Hello! Absolutely, I'd be happy to
                                                                        assist. Could you please let me know which
                                                                        destinations or type of cruise you’re interested
                                                                        in?</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <li class="text-center day-badge mb-4"><span
                                            class="badge badge-light badge-md text-gray-9 fw-normal fs-14 rounded-pill mx-auto">Today,
                                            March 25</span></li>
                                    <li class="media received">
                                        <div class="d-flex align-items-center mb-1">
                                            <div class="avatar avatar-lg flex-shrink-0 me-2">
                                        ...
                                        <div class="media-body flex-grow-1">
                                            <div class="msg-box">
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center ">
                                                        <div class="received-message me-2">
                                                            <p class="fs-14">I was looking at the Caribbean options. Do
                                                                you have any upcoming cruises with stops in the Bahamas
                                                                and Jamaica?</p>
                                                        </div>
                                                        <div class="chat-actions me-2">
                                                            <a href="#" data-bs-toggle="dropdown">
                                                    ...
                                                    <div class="msg-box">
                                                        ...
                                                        <div class="position-relative">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="sent-message">
                                                                    <p class="fs-14">Yes, we do! We have a 7-day
                                                                        Caribbean cruise that includes stops in the
                                                                        Bahamas, Jamaica, and Cozumel, Mexico. It
                                                                        departs on December 15. Would this be of
                                                                        interest?</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="media-body flex-grow-1">
                                            <div class="msg-box">
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center ">
                                                        <div class="received-message me-2">
                                                            <p class="fs-14">Yes, we do! We have a 7-day Caribbean
                                                                cruise that includes stops in the Bahamas, Jamaica, and
                                                                Cozumel, Mexico. It departs on December 15. Would this
                                                                be of interest?</p>
                                                        </div>
                                                        <div class="chat-actions me-2">
                                                            <a href="#" data-bs-toggle="dropdown">
                                                    ...
                                                    <div class="msg-box">
                                                        ...
                                                        <div class="position-relative">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="sent-message">
                                                                    <p class="fs-14">That sounds perfect! Could you tell
                                                                        me about the cabin options and pricing?</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="media-body flex-grow-1">
                                            <div class="msg-box">
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center">
                                                        <div class="received-message me-2">
                                                            <p class="fs-14">Of course. We offer the following cabin
                                                                options</p>
                                                            <div class="d-flex align-items-center">
                                                                <a href="#"><img src="{{URL::asset('build/img/cruise/cruise-14.jpg')}}"
                                                                        alt="image" class="avatar avatar-xxl me-2"></a>
                                                                <a href="#"><img src="{{URL::asset('build/img/cruise/cruise-29.jpg')}}"
                                                                        alt="image" class="avatar avatar-xxl me-2"></a>
                                                                <div class="img-count">
                                                                    <a href="#"><img
                                                                            src="{{URL::asset('build/img/cruise/cruise-13.jpg')}}"
                                                                            alt="image"
                                                                            class="avatar avatar-xxl me-2"></a>
                                                                    <a href="#"><span
                                                                            class="fs-16 fw-medium text-white counts">10+</span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="chat-actions me-2">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        <a href="#"><span><img src="{{URL::asset('build/img/icons/thumbs-up.svg')}}"
                                                                    alt="image"></span></a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-footer border-0">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center chat-input-icons">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end p-3">
                                            <a href="#" class="dropdown-item"><i
                                                    class="isax isax-camera me-2"></i>Camera</a>
                                            <a href="#" class="dropdown-item"><i
                                                    class="isax isax-gallery me-2"></i>Gallery</a>
                                            <a href="#" class="dropdown-item"><i
                                                    class="isax isax-audio-square me-2"></i>Audio</a>
                                            <a href="#" class="dropdown-item"><i
                                                    class="isax isax-location me-2"></i>Location</a>
                                            <a href="#" class="dropdown-item"><i
                                                    class="isax isax-user-cirlce-add me-2"></i>Contact</a>
                                        </div>
                                        <div class="form-item emoj-action-foot">
                                            <a href="javascrip:void(0);" class="action-circle"><i
                                                    class="fa-regular fa-face-smile"></i></a>
                                            <div class="emoj-group-list-foot down-emoji-circle">
                                                <ul>
                                                    <li>
                                                        <a href="#"><img src="{{URL::asset('build/img/icons/emonji-02.svg')}}"
                                                                alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#"><img src="{{URL::asset('build/img/icons/emonji-05.svg')}}"
                                                                alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#"><img src="{{URL::asset('build/img/icons/emonji-06.svg')}}"
                                                                alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#"><img src="{{URL::asset('build/img/icons/emonji-07.svg')}}"
                                                                alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#"><img src="{{URL::asset('build/img/icons/emonji-08.svg')}}"
                                                                alt="Icon"></a>
                                                    </li>
                                                    <li class="add-emoj"><a href="#"><i class="isax isax-add"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <button class="btn btn-primary btn_send"><i class="isax isax-send-25 text-white"
