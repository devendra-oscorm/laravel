...
@section('content')
    ...
    <div class="content">
        <div class="container">
            <div>
                <div class="mb-3">
                    <a href="{{url('agent-enquirers')}}" class="text-primary"><i class="isax isax-arrow-left me-2"></i>Back to
                        Enquiry List</a>
                </div>
                    ...
                    <div class="card mb-4 mb-lg-0">
                        <div class="card-body">
                            ...
                            <div class="mb-4 pb-4 border-bottom">
                                ...
                                <p class="fs-14">I’m planning a group of 10 people for a wine-tasting tour. Could you
                                    send me pricing information for this?</p>
                            </div>
                            <div class="mb-3">
