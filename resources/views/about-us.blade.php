            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-content mb-4">
                        ...
                        <p class="mb-4">At DreamsTour, we believe that travel should be simple, seamless, and tailored
                            to your needs. Whether you're dreaming of an exotic beach getaway, a cultural city tour, or
                    ...
                    <div class="about-mission">
                        ...
                        <p class="fs-16 text-gray-6">Our mission is to make travel more accessible, enjoyable, and
                            hassle-free for everyone. With our range of services</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="choose-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="fs-16 text-gray-6">Plan your entire trip from one platform, saving you time and
                                effort. No more hopping between different websites .</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="choose-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="fs-16 text-gray-6">We work with trusted travel partners to bring you the best
                                deals, whether you're booking a flight, hotel, or car rental.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="choose-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="fs-16 text-gray-6">Our dedicated support team is here for you 24/7, ensuring your
                                travel plans go smoothly from start to finish.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="choose-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="fs-16 text-gray-6">Whether you're traveling for business, family vacations, or a
                                solo adventure, we provide options that suit every needs</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div>
                <div class="row justify-content-center">
                    <div class="col-md-7 d-flex justify-content-center">
                        <div class="header-section text-center">
                            ...
                            <p class="fs-16 text-gray-6">We’re a team of explorers, innovators, and customer-focused
                                professionals who are passionate about making travel easy and accessible for everyone.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center view-all wow fadeInUp">
                    <a href="{{url('team')}}" class="btn btn-dark">View All Experts<i
