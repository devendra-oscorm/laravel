<?php $page="agent-payment-history";?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Payouts</h2>
            ...
            <div class="row">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{url('agent-pending-payouts')}}"
                                                class="fs-14 d-inline-flex align-items-center active">Pending
                                                Payouts</a>
                                        </li>
                                        <li>
                ...
                <div class="col-xl-9 col-lg-8 theiaStickySidebar">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2 mb-3">
                        <a href="{{url('agent-pending-payouts')}}" class="btn btn-light">Pending Payouts</a>
                        <a href="{{url('agent-payment-history')}}" class="btn btn-primary">Payment History</a>
                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-1245</a></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#payoutDetails"><i
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#rejectedpayoutDetails">#PO-3215</a></td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-danger rounded-pill d-inline-flex align-items-center fs-10"><i
                                                        class="fa-solid fa-circle fs-5 me-1"></i>Rejected</span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#rejectedpayoutDetails"><i
                                                            class="isax isax-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-4581</a></td>
                                            <td>
                                                20 Apr 2026, 08:10 AM
                                            </td>
                                            <td>Bank Transfer</td>
                                            <td>$600</td>
                                            <td>$60</td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-6545</a></td>
                                            <td>
                                                12 Apr 2026, 03:15 PM
                                            </td>
                                            <td>Bank Transfer</td>
                                            <td>$400</td>
                                            <td>$40</td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#rejectedpayoutDetails">#PO-3854</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-3256</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-1458</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#rejectedpayoutDetails">#PO-6589</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-2315</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#payoutDetails">#PO-5414</a></td>
                                            <td>
