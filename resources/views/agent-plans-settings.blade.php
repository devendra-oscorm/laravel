                    ...
                    <div class="card settings mb-0">
                        ...
                        <div class="card-body">
                            <div class="settings-link d-flex align-items-center flex-wrap">
                                ...
                                <a href="{{url('agent-plans-settings')}}" class="active"><i class="isax isax-star me-2"></i>Plans &
                                    Billing</a>
                                ...
                                <div class="row">
                                    <div class="col-xl-5 d-flex">
                                        <div class="card shadow-none bg-gray-transparent flex-fill">
                                            <div class="card-body">
                                                <div
                                                    class="border-bottom d-flex align-items-center justify-content-between mb-3 pb-3">
                                                    <h6 class="fw-medium">Active Plan</h6>
                                                    <a href="#" class="btn btn-light btn-sm">Download PDF</a>
                                                </div>
                                                <div
                                                    class="d-flex align-items-center justify-content-between border-bottom mb-4 pb-4">
                                                    <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <a href="#" class="btn btn-light btn-sm me-2">Cancel
                                                        Subscription</a>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#price_plane"
                                                        class="btn btn-primary btn-sm">Update Plan</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#add_card"><i
                                                            class="isax isax-add me-1"></i>Add New Card</a>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col-md-6">
                                                        <div class="card mb-0">
                                                            <div class="card-body p-3">
                                                                <div class="d-flex align-items-center mb-3">
                                                                    <span
                                                                        class="payment-img d-flex align-items-center justify-content-center flex-shrink-0 rounded border me-2">
                                                                        <img src="{{URL::asset('build/img/icons/visa-3.svg')}}" alt="">
                                                                    </span>
                                                                    <div>
                                                                        <span class="fs-14 mb-1 d-block">Credit
                                                                            Card</span>
                                                                        <h6 class="fs-14 fw-medium text-truncate">Visa
                                                                            •••• 1568</h6>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    ...
                                                                    <a href="#"
                                                                        class="btn btn-primary btn-sm">Default</a>
                                                                    <div
                                                                        class="d-flex align-items-center edit-delete-icon">
                                                                        <a href="#"
                                                                        ...
                                                                        <a href="#" class="avatar rounded-circle border"
                                                                            data-bs-toggle="modal"
                                                        ...
                                                        <div class="card mb-0">
                                                            <div class="card-body p-3">
                                                                <div class="d-flex align-items-center mb-3">
                                                                    ...
                                                                    <div>
                                                                        <span class="fs-14 mb-1 d-block">Debit
                                                                            Card</span>
                                                                ...
                                                                <div
                                                                    class="d-flex align-items-center justify-content-between">
                                                                    <a href="#"
                                                                        class="text-primary text-decoration-underline fs-14">Set
                                                                        as Default</a>
                                                                    <div
                                                                        class="d-flex align-items-center edit-delete-icon">
                                                                        <a href="#"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="#" class="link-primary fw-medium"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#transaction_detail">#IN-1245</a></td>
                                                        <td>
                                                            <h6 class="fs-14 fw-medium">Standard Plan</h6>
                                                        </td>
                                                        <td>Credit Card</td>
                                                        <td>15 May 2025</td>
                                                        <td>14 Jun 2025</td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <a href="#" data-bs-toggle="modal"
                                                                    data-bs-target="#transaction_detail" class="me-2"><i
                                                    ...
                                                    <tr>
                                                        <td><a href="#" class="link-primary fw-medium"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#transaction_detail">#IN-3215</a></td>
                                                        <td>
                                                            <h6 class="fs-14 fw-medium">Basic Plan</h6>
                                                        </td>
                                                        <td>Debit Card</td>
                                                        <td>15 Apr 2025</td>
                                                        <td>14 May 2025</td>
                                                    ...
                                                    <tr>
                                                        <td><a href="#" class="link-primary fw-medium"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#transaction_detail">#IN-4581</a></td>
                                                        <td>
                                                            <h6 class="fs-14 fw-medium">Premium Plan</h6>
                                                        </td>
                                                        <td>Paypal</td>
                                                        <td>15 Mar 2025</td>
                                                        <td>14 Apr 2025</td>
                                                    ...
                                                    <tr>
                                                        <td><a href="#" class="link-primary fw-medium"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#transaction_detail">#IN-6545</a></td>
                                                        <td>
                                                            <h6 class="fs-14 fw-medium">Basic Plan</h6>
                                                        </td>
                                                        <td>Debit Card</td>
                                                    ...
                                                    <tr>
                                                        <td><a href="#" class="link-primary fw-medium"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#transaction_detail">#IN-5769</a></td>
                                                        <td>
                                                            <h6 class="fs-14 fw-medium">Standard Plan</h6>
                                                        </td>
                                                        <td>Stripe</td>
