                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                <a href="{{url('cruise-grid')}}" class="list-icon active me-2"><i
                                        class="isax isax-grid-1"></i></a>
                                <a href="{{url('cruise-list')}}" class="list-icon me-2"><i
                        ...
                        <div class="col-xl-4 col-md-6 d-flex">
                            <div class="place-item mb-4 flex-fill">
                                ...
                                <div class="place-content">
                                    ...
                                    <h5 class="mb-1 text-truncate"><a href="{{url('cruise-details')}}">Sailor’s Delight</a>
                                    </h5>
                                    <p class="d-flex align-items-center mb-3"><i
                                    ...
                                    <div class="curise-details d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div>
                                            <p class="mb-1"><i class="isax isax-fatrows text-gray-6 me-1"></i>Width :
                                                <span class="text-dark fw-medium">95.14 m</span>
                                            </p>
                                            <p><i class="isax isax-flash-1 me-1"></i>Speed : <span
                                                    class="text-dark fw-medium">16 Knots</span></p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                        <h6 class="d-flex align-items-center"><i
