...
@section('content')
    ...
    <section class="section destination-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        ...
                        <p class="sub-title">DreamsTour Marketplace is a platform designed to connect fans with
                            exclusive experiences related to a specific tour</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{url('hotel-grid')}}" class="btn btn-dark d-inline-flex align-items-center">View All Locations<i
                        ...
                        <div class="place-item mb-4">
                            ...
                            <div class="place-content">
                                <div class="flight-loc d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="#" class="arrow-icon"><i class="isax isax-arrow-2"></i></a>
                                    <span class="loc-name d-inline-flex align-items-center"><i
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex align-items-center flex-wrap about-btn gap-2">
                        <a href="{{url('about-us')}}" class="btn btn-white d-flex align-items-center">Learn More<i
    ...
    <section class="section experts-section">
        <div class="container">
            ...
            <div class="owl-carousel experts-slider-rtl nav-center">
                ...
                <div class="expert-item mb-4">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{URL::asset('build/img/flags/brazil.svg')}}" alt="img"
                ...
                <div class="expert-item mb-4">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{URL::asset('build/img/flags/japan.svg')}}" alt="img"
                ...
                <div class="expert-item mb-4">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{URL::asset('build/img/flags/africa.svg')}}" alt="img"
                ...
                <div class="expert-item mb-4">
                    ...
                    <div class="expert-content">
                        ...
                        <h5 class="mb-1"><a href="#">Damien Martien</a></h5>
                        <p class="d-flex align-items-center"><img src="{{URL::asset('build/img/flags/australia.svg')}}" alt="img"
                ...
                <div class="expert-item mb-4">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{URL::asset('build/img/flags/norway.svg')}}" alt="img"
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{url('team')}}" class="btn btn-dark d-inline-flex align-items-center">View All Experts<i
                        class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                        <div class="section-header text-center">
                            ...
                            <p class="sub-title">DreamsTour, a tour operator specializing in dream destinations, offers
                                a variety of benefits for travelers.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">Exploring the World: Your Ultimate Dream Tour Itinerary</a>
                            </h5>
                        </div>
                    </div>
                </div>
