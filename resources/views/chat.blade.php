        ...
        <div class="container">
            <div class="customer-chat">
                <div class="header-navigation">
                    <a href="{{url('dashboard')}}" class="d-inline-flex align-items-center"><i
                                                        ...
                                                        <div class="position-relative">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="sent-message">
                                                                    <p class="fs-14">Hello! I’m interested in booking a
                                                                        cruise tour. Could you help me with some
                                                                        details?</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center ">
                                                        <div class="received-message me-2">
                                                            <p class="fs-14">Hello! Absolutely, I'd be happy to assist.
                                                                Could you please let me know which destinations or type
                                                                of cruise you’re interested in?</p>
                                                        </div>
                                                        <div class="chat-actions me-2">
                                                            <a href="#" data-bs-toggle="dropdown">
                                                                <i class="fa-solid fa-ellipsis-vertical"></i>
                                                    ...
                                                    <div class="msg-box">
                                                        ...
                                                        <div class="position-relative">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="sent-message">
                                                                    <p class="fs-14">I was looking at the Caribbean
                                                                        options. Do you have any upcoming cruises with
                                                                        stops in the Bahamas and Jamaica?</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
