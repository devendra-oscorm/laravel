                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">How to Travel on a Budget: Affordable Destinations &
                                    Tips</a></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">The Ultimate Guide to Solo Travel: Tips for First-Time
                                    Travelers</a></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">Top 10 Breath taking Destinations You Must Visit in 2025</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">How to Plan the Perfect Weekend Getaway: Quick Travel
                                    Tips</a></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">Top 7 Beach Destinations for a Relaxing Summer Vacation</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-info text-center">
                            ...
                            <h5><a href="{{url('blog-details')}}">The Best Flight Tours Over Iconic Landmarks You Have to
                                    Experience</a></h5>
                        </div>
                    </div>
                </div>
