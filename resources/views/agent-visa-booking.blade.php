        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Visa Bookings</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="isax isax-grid-55"></i></a></li>
                            <li class="breadcrumb-item active" aria-current="page">My Bookings</li>
                            <li class="breadcrumb-item active" aria-current="page">Visa Bookings</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#applied">#VB-3256</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Electronic Visa for...</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Business Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#applied">#VB-3654</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Long term for Academic..</a>
                                                        </p>
                                                        <span class="fs-14 fw-normal text-gray-6">Student Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#progress">#VB-4581</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Work Visa for Employm...</a>
                                                        </p>
                                                        <span class="fs-14 fw-normal text-gray-6">Work Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VB-6545</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Short term Visa for...</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Business Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Family Members to...</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Family Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Cultural Programs and...</a>
                                                        </p>
                                                        <span class="fs-14 fw-normal text-gray-6">Dependent Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VB-1458</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Grown up E-visa with...</a>
                                                        </p>
                                                        <span class="fs-14 fw-normal text-gray-6">Transit Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VB-6589</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Voluntary Work with...</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Work Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#VB-2315</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('guide-details')}}">Skilled Workers with...</a>
                                                        </p>
                                                        <span class="fs-14 fw-normal text-gray-6">Work Visa</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#progress">#VB-5414</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                        ...
                                                        <span class="fs-14 fw-normal text-gray-6">Tourist Visa</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
