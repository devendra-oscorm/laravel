                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('customer-car-booking')}}"
                                                class="fs-14 d-inline-flex align-items-center active">Cars</a>
                                        </li>
                                        <li>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CB-1245</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#upcoming">#CB-3215</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Toyota Camry SE 400</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#pending">#CB-6545</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                    ...
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Ferrari 458 MM Special</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#cancelled">#CB-3256</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cars/car-09.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}"> Mercedes-benz </a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#cancelled">#CB-3654</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cars/car-10.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">BMW 3.0 Gran Turismo</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Hatchback</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CB-1458</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cars/car-11.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Infiniti QX60 </a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Hatchback</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CB-6589</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cars/car-12.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Toyota 86 Coupe</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Sedan</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CB-2315</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cars/car-13.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Jeep Wrangler</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Coupe</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
                                                    data-bs-target="#completed">#CB-5414</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('car-details')}}" class="avatar avatar-lg"><img
                                                            src="{{URL::asset('build/img/cars/car-14.jpg')}}"
                                                            class="img-fluid rounded-circle" alt="img"></a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a
                                                                href="{{url('car-details')}}">Jaguar XK</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Sedan</span>
                                                    </div>
                                                </div>
                                            </td>
