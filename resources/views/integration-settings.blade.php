                    ...
                    <div class="card settings mb-0">
                        ...
                        <div class="card-body pb-1">
                            <div class="settings-link d-flex align-items-center flex-wrap">
                                ...
                                <a href="{{url('integration-settings')}}" class="active ps-3"><i
                                            ...
                                            <div class="integration-content">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <div class="d-flex align-items-center">
                                                        <span class="icons me-2"><img src="{{URL::asset('build/img/icons/google.svg')}}"
                                                ...
                                                <div>
                                                    <p class="fs-14">Used to find travel destinations, accommodations &
                                                        reviews with ease.</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <div class="d-flex align-items-center">
                                                        <span class="icons me-2"><img
                                                                src="{{URL::asset('build/img/icons/google-calender.svg')}}" alt="icon"
                                        ...
                                        <div class="card-body">
                                            <div class="integration-content">
                                                <div class="d-flex align-items-center justify-content-between mb-2">
                                                    <div class="d-flex align-items-center">
                                                        <span class="icons me-2"><img
                                                                src="{{URL::asset('build/img/icons/google-map.svg')}}" alt="icon"
                                                                class="img-fluid"></span>
                                                ...
                                                <div>
                                                    <p class="fs-14">Boosts with interactive routes, destinations &
