                ...
                <div class="col-md-9">
                    <div class="card mb-0">
                        <div class="card-body">
                                ...
                                <div class="row justify-content-between align-items-center flex-wrap row-gap-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class=" text-end mb-3">
                                            <h6 class="text-default mb-1">Invoice No <span
                                                    class="text-primary fw-medium">#INV0001</span></h6>
                                            <p class="fs-14 mb-1 fw-medium">Created Date : <span class="text-gray-9">Sep
                                                    24, 2023</span> </p>
                                            <p class="fs-14 fw-medium">Due Date : <span class="text-gray-9">Sep 30,
                                                    2023</span> </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center g-4">
                                    <div class="col-md-5">
                                        ...
                                        <div>
                                            ...
                                            <p class="fs-14 mb-1">Email : <span
                                                    class="text-gray-9">tarala2445@example.com</span></p>
                                            <p class="fs-14">Phone : <span class="text-gray-9">+1 987 654 3210</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="fs-14 mb-1">Email : <span
                                                    class="text-gray-9">sara_inc34@example.com</span></p>
                                            <p class="fs-14">Phone : <span class="text-gray-9">+1 987 471 6589</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <span class="badge badge-danger align-items-center fs-10 mb-4"><i
                            ...
                            <div>
                                <p class="fw-medium mb-3">Invoice For : <span class="text-dark fw-medium">Hotel
                                        Booking</span></p>
                                <div class="table-responsive">
                                    <table class="table invoice-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <h6 class="fs-14">Additional Service ( Airport Pickup, Breakfast )
                                                    </h6>
                                                </td>
                                                <td class="text-gray fs-14 fw-medium text-center">1</td>
                            ...
                            <div class="row border-bottom mb-3">
                                <div class="col-md-7">
                                    <div class="py-4">
                                        <div class="mb-3">
                                            ...
                                            <p class="fs-12">Please pay within 15 days from the date of invoice, overdue
                                ...
                                <div class="col-md-5">
                                    <div
                                        class="d-flex justify-content-between align-items-center border-bottom my-2 pe-3">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-gray-9 fs-12 mb-1">Payment Made Via bank transfer / Cheque in the name of
                                    Thomas Lawler</p>
                                <div class="d-flex justify-content-center align-items-center flex-wrap gap-2">
                                    <p class="fs-12 mb-0">Bank Name : <span class="text-gray-9">HDFC Bank</span></p>
                                    <p class="fs-12 mb-0">Account Number : <span class="text-gray-9">45366287987</span>
                                    </p>
