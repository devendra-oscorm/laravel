                                    ...
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="avatar avatar-lg rounded-circle flex-shrink-0 me-2">
                                                <img src="{{URL::asset('build/img/users/user-22.jpg')}}" alt="user"
                                        ...
                                        <div>
                                            <p class="fs-14 d-flex align-items-center mb-2"><i
                                                    class="isax isax-info-circle5 text-gray-9 me-2"></i>Info : Hotel
                                                Booking (Hayat Hotel)</p>
                                            <p class="fs-16 mb-0">Booked a last-minute flight with ease, and everything
                                                went smoothly from start to finish</p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <span class="fs-14 d-flex align-items-center">3 days ago<i
                                                            class="ti ti-point-filled text-gray mx-2"></i></span>
                                                    <p class="fs-14"><span
                                        ...
                                        <div>
                                            <p class="fs-14 d-flex align-items-center mb-2"><i
                                                    class="isax isax-info-circle5 text-gray-9 me-2"></i>Info : Cuise
                                                Booking (Super Aquamarine)</p>
                                            <p class="fs-16 mb-0">Our first cruise was amazing, with great service,
                                                food, and excursions. Can’t wait to go again!</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="btn btn-light btn-sm border add-reply me-2">Reply</a>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <span class="fs-14 d-flex align-items-center">05 days ago<i
                                                            class="ti ti-point-filled text-gray mx-2"></i></span>
                                                    <p class="fs-14"><span
                                        ...
                                        <div>
                                            <p class="fs-14 d-flex align-items-center mb-2"><i
                                                    class="isax isax-info-circle5 text-gray-9 me-2"></i>Info : Tour
                                                Booking (Joy Jubilee Jamboree)</p>
                                            <p class="fs-16 mb-0">The tour was well-organized, and the guides were
                                                knowledgeable and friendly—an unforgettable experience!</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="btn btn-light btn-sm border add-reply me-2">Reply</a>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap">
                                                    <span class="fs-14 d-flex align-items-center">08 days ago<i
                                                            class="ti ti-point-filled text-gray mx-2"></i></span>
                                                    <p class="fs-14"><span
                                        ...
                                        <div>
                                            <p class="fs-14 d-flex align-items-center mb-2"><i
                                                    class="isax isax-info-circle5 text-gray-9 me-2"></i>Info : Car
                                                Booking (Volkswagen Amarok)</p>
                                            <p class="fs-16 mb-0">The booking process was quick, and the car was ready
                                                on time with no issues and super convenient</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="btn btn-light btn-sm border add-reply me-2">Reply</a>
                            ...
                            <div>
                                <div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2">
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="avatar avatar-lg rounded-circle flex-shrink-0 me-2">
                                                <img src="{{URL::asset('build/img/users/user-25.jpg')}}" alt="user"
                                                    class="img-fluid rounded-circle">
                                            </span>
                                            <div>
                                        ...
                                        <div>
                                            <p class="fs-14 d-flex align-items-center mb-2"><i
                                                    class="isax isax-info-circle5 text-gray-9 me-2"></i>Info : Hotel
                                                Booking (Hotel Athenee)</p>
                                            <p class="fs-16 mb-0">The hotel was family-friendly, with spacious rooms and
                                                activities for the kids—great stay!</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="btn btn-light btn-sm border add-reply me-2">Reply</a>
                                ...
                                <div class="bg-light rounded p-3 mt-3 ms-5">
                                    <p><span class="fw-medium">You Replied : </span> Booked a last-minute flight with
                                        ease, and everything went smoothly from start to finish</p>
                                </div>
                                <div class="review-reply border-top mt-3 pt-3">
                                    <form action="{{url('agent-review')}}" class="reply-form">
                                        <textarea rows="3" class="form-control" placeholder="Add Comment"></textarea>
