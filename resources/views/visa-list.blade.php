                ...
                <div class="col-md-12 col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Visa List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                <a href="{{url('visa-grid')}}" class="list-icon me-2"><i class="isax isax-grid-1"></i></a>
                                <a href="{{url('visa-list')}}" class="list-icon active me-2"><i
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-01.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                            ...
                                            <span
                                                class="badge bg-white text-dark d-inline-flex align-items-center">Business
                                                Visa</span>
                                        </div>
                                    </div>
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Electronic Visa
                                                    for Tourism and Recreation</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : Electronic</p>
                                                <p class="fs-14 mb-0"><i
                                                        class="ti ti-point-filled text-primary me-2"></i>Validity : 90
                                                    Days</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <div class="mb-0">
                                                <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">From
                                                    <span class="ms-1 fs-18 fw-semibold text-primary">$700</span><span
                                                        class="ms-1 fs-14 text-gray-3">/ Person</span>
                                                </h6>
                                            </div>
                                            <div class="ms-2 d-flex align-items-center">
                                                <p class="d-flex fs-14 align-items-center mb-0"><i
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-02.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                            ...
                                            <span
                                                class="badge bg-white text-dark d-inline-flex align-items-center">Student
                                                Visa</span>
                                        </div>
                                    </div>
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Long term for
                                                    Academic with Health Insurance</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : Consular Visa</p>
                                                <p class="fs-14 mb-0"><i
                                                        class="ti ti-point-filled text-primary me-2"></i>Validity : 1
                                                    Year</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-03.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                    ...
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Work Visa for
                                                    Employment Opportunities</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : Paper</p>
                                                <p class="fs-14 mb-0"><i
                                                        class="ti ti-point-filled text-primary me-2"></i>Validity : 2
                                                    Years</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <div class="mb-0">
                                                <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">From
                                                    <span class="ms-1 fs-18 fw-semibold text-primary">$800</span><span
                                                        class="ms-1 fs-14 text-gray-3">/ Person</span>
                                                </h6>
                                            </div>
                                            <div class="ms-2 d-flex align-items-center">
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-04.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                    ...
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Short term Visa
                                                    for Travelers with Layovers</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : Electronic</p>
                                                <p class="fs-14 mb-0"><i
                                                        class="ti ti-point-filled text-primary me-2"></i>Validity : 72
                                                    Hours</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <div class="mb-0">
                                                <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">From
                                                    <span class="ms-1 fs-18 fw-semibold text-primary">$100</span><span
                                                        class="ms-1 fs-14 text-gray-3">/ Person</span>
                                                </h6>
                                            </div>
                                            <div class="ms-2 d-flex align-items-center">
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-05.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                            ...
                                            <span
                                                class="badge bg-white text-dark d-inline-flex align-items-center">Family
                                                Reunion Visa</span>
                                        </div>
                                    </div>
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Family Members to
                                                    Join Relatives</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : Paper</p>
                                                <p class="fs-14 mb-0"><i
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-06.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                            ...
                                            <span
                                                class="badge bg-white text-dark d-inline-flex align-items-center">Cultural
                                                Exchange Visa</span>
                                        </div>
                                    </div>
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Cultural Programs
                                                    and Exchanges</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : Electronic</p>
                                                <p class="fs-14 mb-0"><i
                                                        class="ti ti-point-filled text-primary me-2"></i>Validity : 6
                                                    Months</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="slide-images">
                                            <a href="{{url('visa-details')}}">
                                                <img src="{{URL::asset('build/img/visa/visa-07.jpg')}}" class="img-fluid w-100"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="fav-item">
                                            ...
                                            <span
                                                class="badge bg-white text-dark d-inline-flex align-items-center">Research
                                                Visa</span>
                                        </div>
                                    </div>
                                    <div class="place-content d-flex flex-column justify-content-between">
                                        ...
                                        <div>
                                            <h5 class="mb-2 text-truncate"><a href="{{url('visa-details')}}">Grown up E-visa
                                                    with Cooling and Assurance.</a></h5>
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <p class="d-flex align-items-center fs-14 mb-0">Mode : e-Visa</p>
                                                <p class="fs-14 mb-0"><i
                                                        class="ti ti-point-filled text-primary me-2"></i>Validity : 1
                                                    Year</p>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <div class="mb-0">
                                                <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">From
                                                    <span class="ms-1 fs-18 fw-semibold text-primary">$900</span><span
                                                        class="ms-1 fs-14 text-gray-3">/ Person</span>
                                                </h6>
                                            </div>
                                            <div class="ms-2 d-flex align-items-center">
