                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider tour-img tour-img owl-carousel nav-center h-100">
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-08.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-09.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-10.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-11.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-content">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <p class="fs-14 text-gray-9  border-end pe-2 me-2 mb-0">
                                                    <span class="me-1"><i
                                                            class="ti ti-receipt text-primary"></i></span>Adventure Tour
                                                </p>
                                                <span
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider tour-img tour-img owl-carousel nav-center h-100">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-12.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider tour-img tour-img owl-carousel nav-center h-100">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-13.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="place-item mb-4">
                                    <div class="place-img">
                                        <div class="img-slider tour-img tour-img owl-carousel nav-center h-100">
                                            ...
                                            <div class="slide-images">
                                                <a href="{{url('tour-details')}}">
                                                    <img src="{{URL::asset('build/img/tours/tours-14.jpg')}}" class="img-fluid h-100"
                                                        alt="img">
                                                </a>
                                            </div>
                                        </div>
