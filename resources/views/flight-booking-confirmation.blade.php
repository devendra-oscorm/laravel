								...
								<div class="d-flex flex-wrap align-items-center justify-content-between ">
									<div class="d-flex flex-wrap align-items-center booking-hotels">
										<a href="{{url('flight-details')}}" class="avatar avatar-lg me-2">
											<img src="{{URL::asset('build/img/flight/flight-01.jpg')}}" alt="image"
										...
										<div class="booking-details">
											...
											<div class="d-flex flex-wrap align-items-center booking-items">
												<p
													...
													<img src="{{URL::asset('build/img/icons/airindia.svg')}}" alt="image"
														class="avatar avatar-sm avatar-rounded me-2">Air India
												</p>
												<p
													class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
