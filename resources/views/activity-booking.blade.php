                            ...
                            <div class="wizard-container">
                                ...
                                <div class="step-content active" data-step="1">
                                    ...
                                    <div class="steps">
                                        ...
                                        <a class="step pointer-none" href="{{url('activity-booking-confirmation')}}"><span>3</span> Confirmation</a>
                                    </div>
                                    ...
                                    <div class="text-end">
                                        <button class="btn btn-primary next-step d-flex align-items-center gap-1">Proceed to Payment <i class="isax isax-arrow-right-3 ms-1"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="step-content" data-step="2">
                                    ...
                                    <div class="steps">
                                        ...
                                        <div class="step" data-step="2"><span>2</span> Payment Details</div>
                                        <a class="step" href="{{url('activity-booking-confirmation')}}"><span>3</span> Confirmation</a>
                                    </div>
                                    ...
                                    <div class="actions d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="{{url('activity-booking-confirmation')}}" class="btn btn-primary">Confirm & Pay $9569</a>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="pb-3 border-bottom">
                                <div class="mb-3 review-img">
                                    <img src="{{URL::asset('build/img/activities/activity-01.jpg')}}" alt="Img" class="img-fluid">
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h6 class="mb-2">Tropical Reef Snorkeling Adventure</h6>
                                        <div class="d-flex">
                                            <p class="fs-14"><span
                            ...
                            <div class="mt-3 pb-3 border-bottom">
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100 details-info">
                                    <h6 class="fs-16">Date</h6>
                                    <p class="fs-16">15 Sep 2025</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between w-100 details-info">
                                    <h6 class="fs-16">Time</h6>
                                    <p class="fs-16">08:00 AM - 12:00 PM</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between w-100 details-info">
                                    <h6 class="fs-16">Duration</h6>
                                    <p class="fs-16">4 hours</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between w-100 details-info">
                            ...
                            <div class="mt-3 border-bottom">
                                ...
                                <div class="mt-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <div class=" text-dark fw-medium">Tax <span class="text-gray-6"> (10%)</span>
                                        </div>
                                        <p class="fs-16">$85</p>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <div class=" text-dark fw-medium">Discount <span class="text-gray-6">
                                                (10%)</span></div>
                                        <p class="fs-16">-$20</p>
                                    </div>
                                </div>
